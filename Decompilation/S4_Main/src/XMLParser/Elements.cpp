...
namespace AdvXMLParser {
    ...
    Attribute *Attribute::Clone(NodeContainer &parent) const {
        ...
        unique_ptr<Attribute> pAttribute(new Attribute(parent, GetName()));
    ...
    EntityRef *EntityRef::Clone(NodeContainer & /*parent*/) const {
        unique_ptr<EntityRef> pEntity(new EntityRef(GetName()));
        pEntity->m_c = m_c;
    ...
    Element *Element::Clone(NodeContainer &parent) const {
        ...
        unique_ptr<Element> pElement(new Element(parent, GetName()));
    ...
    Attribute &Element::CreateAttribute(const Char *szName) {
        ...
        unique_ptr<Attribute> pNewAttr(new Attribute(advself, szName));
