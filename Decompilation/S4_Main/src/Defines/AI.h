...
enum T_AI_WARRIOR_TYPE {
    ...
    AI_WARRIOR_TYPE_VEHICLE_WAR = 8,
    AI_WARRIOR_TYPE_VEHICLE_MISC = 9,
    AI_WARRIOR_TYPE_SHIP_WAR = 10,
    AI_WARRIOR_TYPE_TOWER_BUILDING = 12,
    AI_WARRIOR_TYPE_DONKEY = 14,
    AI_WARRIOR_TYPE_LAST = AI_WARRIOR_TYPE_DONKEY,
};
