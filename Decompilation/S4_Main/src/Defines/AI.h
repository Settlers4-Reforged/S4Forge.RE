...
enum T_AI_TASK_FORCE_TYPE {
    ...
    AI_TASK_FORCE_TYPE_RESERVOIR,
    AI_TASK_FORCE_TYPE_UNKNOWN_2,
    AI_TASK_FORCE_TYPE_UNKNOWN_3,
    AI_TASK_FORCE_TYPE_UNKNOWN_4,
    AI_TASK_FORCE_TYPE_UNKNOWN_5,
    AI_TASK_FORCE_TYPE_UNKNOWN_6,
    AI_TASK_FORCE_TYPE_UNKNOWN_7,
    AI_TASK_FORCE_TYPE_PRIESTS = 8,
    AI_TASK_FORCE_TYPE_UNKNOWN_9,
    AI_TASK_FORCE_TYPE_UNKNOWN_10,
