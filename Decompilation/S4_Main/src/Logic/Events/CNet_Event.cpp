...
CNet_Event::CNet_Event(CNet_Event const &a2) : CEvn_Logic(a2)
{
}
...
CNet_Event::CNet_Event(unsigned int a2, unsigned int a3, unsigned int a4, unsigned char a5, unsigned int a6, unsigned short a7, unsigned int a8) : CEvn_Logic(a2, a3, a4, a5, a6, a7)
{
  this->m_iTick = a8;
}
