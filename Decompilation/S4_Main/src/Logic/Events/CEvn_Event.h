...
struct SEventStruct
{
  ...
  int m_iTick;
  BYTE m_iFlags;
  BYTE unk_15; // probably padding
  BYTE unk_16; // probably padding
  BYTE unk_17; // probably padding
};
...
public:
  ...
  // address=[0x1352be0]
  virtual void Load(IS4Chunk &a2) override;

  // address=[0x1352bf0]
  virtual void Save(IS4Chunk &a2) override;
