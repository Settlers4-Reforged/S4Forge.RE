...
CS4InvalidMapException::CS4InvalidMapException(class CS4InvalidMapException const &a2) : CBBException(a2) {}
...
CS4InvalidMapException::CS4InvalidMapException(void) : CBBException() {}


// address=[0x1313f80]
// Decompiled from CBBException *__thiscall CS4InvalidMapException::~CS4InvalidMapException(CS4InvalidMapException *this)
CS4InvalidMapException::~CS4InvalidMapException(void) = default;
