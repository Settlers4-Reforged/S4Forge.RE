...
class CEntityTask : public CPersistence {
  public:
    ...
    // address=[0x14d7e80]
    CEntityTask(class CEntityTask const &_rCloneSource);

    // address=[0x14d8620]
    virtual unsigned long ClassID(void) const;

    // address=[0x14dfb60]
    CEntityTask(int a2, int a3, int a4, int a5, int a6, int a7, int a8, bool a9, bool a10, int a11, unsigned int a12,
