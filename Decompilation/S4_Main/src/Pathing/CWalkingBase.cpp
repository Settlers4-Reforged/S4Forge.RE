...
void CWalkingBase::Init(int _iWalkState, int _iFlags) {
    // [esp+14h] [ebp+Ch]
    ...
    if(_iWalkState < 0) {
        ...
        this->m_sData.m_iWalkState = _iWalkState != -1;
    } else {
        this->m_sData.m_iWalkToXY = _iWalkState;
        this->m_sData.m_iWalkToIndex = CWorldManager::Index(_iWalkState);
...
void CWalkingBase::Init(class CWalking *_pAttachment, int _iFlags) {
    this->Init(-1, _iFlags);
    CWalkingBase::AttachWalking(dynamic_cast<CWalkingBase *>(_pAttachment));
}
...
int CWalkingBase::IdleWalk(int a2, int a3) {
    ...
    if(v25 && (v18 || v25 > 2) || CWorldManager::MoveCostsBits(v15) != 7) {
        ...
        if((CWalkingBase::Flags() & 0x20000) != 0 && v40[Grid::TurnLeft(this->m_sData.field_8)] == 2 && v40[this->m_sData.field_8] == 2 && v40[this->m_sData.field_8 + 1] == 2) {
            this->m_sData.m_uFlags &= ~0x20000u;
        ...
        if(this->m_sData.m_iIdleWalkToXY < 0) {
            ...
            for(int jj = 0; jj < SurroundingHexPointsCount(15); ++jj) {
                ...
                if(CWorldManager::InWorld(v12, v17)) {
                    ...
                    if(this->SectorId(v13) == v9 && this->IsNotOccupied(v13) && CWorldManager::MoveCostsBits(v13) < 7) {
                        v16 = v12;
                        v8 = v17;
                        break;
                    }
