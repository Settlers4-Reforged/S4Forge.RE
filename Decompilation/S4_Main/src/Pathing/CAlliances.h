...
private:
    ...
    // address=[0x415c3c0]
    static struct SAlliancesData {
        int m_iNumberOfPlayers;
        int m_iNumberOfAlliances;
        int m_iLastPlayerId;
        int m_iLastAllianceId;
        int m_iAllPlayersBits;
        int m_iAllianceIds[9];
        int m_iPlayersAllyBits[9];
        int m_iPlayersEnemyBits[9];
        int m_iAlliancesNumberOfAllies[9];
        int m_iAlliancesNumberOfEnemies[9];
        int m_iAllyPlayerIds[9][8];
        int m_iEnemyPlayerIds[9][8];
    } m_sData;
};
