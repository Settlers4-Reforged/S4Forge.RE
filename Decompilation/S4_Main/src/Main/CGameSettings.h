...
public:
    ...
    // address=[0x14c1000]
    static std::string __cdecl GetHelpURLenglish();

    // address=[0x14c1040]
    static std::string __cdecl GetHelpURLgerman();

    // address=[0x14c1080]
    static std::string __cdecl GetNormURLenglish();

    // address=[0x14c10c0]
    static std::string __cdecl GetNormURLgerman();
...
private:
    ...
    // address=[0x3f45124]
    static unsigned char m_uiCampaignSave[4];
    ...
    // address=[0x3f452c8]
    static std::wstring m_wstrAINames[9];
