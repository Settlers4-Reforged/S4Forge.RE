...
public:
    ...
    // address=[0x13736d0]
    static class CPlayerInfo const & __cdecl PlayerInfo(int _iPlayerId);

    // address=[0x13919d0]
    static int __cdecl Color(int _iPlayerId);
    ...
    // address=[0x1460650]
    static bool __cdecl IsAlive(int _iPlayerId);

    // address=[0x147a320]
    static bool __cdecl IsAI(int _iPlayerId);

    // address=[0x1486e90]
    static int __cdecl GetPlayerControl(int _iPlayerId);

    // address=[0x14973a0]
    static void __cdecl Init(void);

    // address=[0x1497420]
    static int __cdecl AddPlayer(int _iPlayerRace, int _iPlayerX, int _iPlayerY, int _iPlayerColor, int _iPlayerIP, int _iPeerId, std::wstring _swPlayerName, int _iType);
    ...
    // address=[0x14aae50]
    static void __cdecl PlayerDied(int _iPlayerId);

    // address=[0x14b4800]
    static int __cdecl PeerId(int _iPlayerId);

    // address=[0x14b4930]
    static void __cdecl SetLocalPlayerId(int _iPlayerId);

    // address=[0x14b4980]
    static void __cdecl SetPlayerControl(int _iPlayerId, int _iControlType);

    // address=[0x15c4d00]
    static int __cdecl IP(int _iPlayerId);
