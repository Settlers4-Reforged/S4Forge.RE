...
public:
    ...
    // address=[0x2fd5720]
    bool  Init(wchar_t *,int,bool,int,int,int);
    ...
    // address=[0x2fd5a40]
    unsigned int  PlayStream(wchar_t const *,int,int);
    ...
    // address=[0x2fd6090]
    bool  AddTitleToPlaylist(int,std::wstring *,int);
    ...
    // address=[0x2fd61f0]
    void  VCToggleRecording(bool);

    // address=[0x2fd6220]
    bool  VCStart(class IEventEngine *,int);

    // address=[0x2fd6330]
    void  VCStop(void);

    // address=[0x2fd6380]
    bool  VCReceivePackage(signed char *,int);
    ...
    // address=[0x2fd6460]
    void  VCSetTestMode(bool);

    // address=[0x2fd6490]
    void  VCSetVolume(int);

    // address=[0x2fd64c0]
    void  VCSetMicVolume(int);
