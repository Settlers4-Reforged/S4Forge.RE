...
enum CAITaskForce::T_RESULT  CAITaskForce::AddEntity(class CAIEntityInfo * _pEntityInfo, enum CAITaskForce::T_POSITION a3) {
  ...
  CAIEntityInfo::SetTimeStamp(_pEntityInfo, 0);
...
enum CAITaskForce::T_RESULT  CAITaskForce::AddEntity(int _iEntityId, enum CAITaskForce::T_POSITION a3) {
  ...
  if ( pEntityInfo )
  {
    ...
    return this->AddEntity(this, pEntityInfo, a3);
  }
  else
  {
...
void  CAITaskForce::Load(class IS4Chunk & a2) {
  ...
  this->RemoveAllEntities(this);
  a2->LoadSignature(-1516371712);
  a2->LoadUnsigned32(1, 1);
  a2->LoadSignature(-1516371710);
  this->m_uNewCounter = a2->LoadUnsigned32_(a2);
  this->m_bState = a2->LoadUnsigned32_(a2);
  this->m_iNextState = a2->LoadUnsigned32_(a2);
  this->m_bStatus = a2->LoadUnsigned32_(a2);
  this->m_uFlags = a2->LoadUnsigned32_(a2);
  this->m_uCmdGoal = a2->LoadUnsigned32_(a2);
  this->m_uCmdUniqueId = a2->LoadUnsigned32_(a2);
  this->m_uCmdTimeStamp = a2->LoadUnsigned32_(a2);
  this->m_uStatusTimeStamp = a2->LoadUnsigned32_(a2);
...
void  CAITaskForce::Save(class IS4Chunk & a2) {
  ...
  int v2; // [esp+0h] [ebp-10h]
  int iCounter; // [esp+4h] [ebp-Ch]
  int pEntity; // [esp+8h] [ebp-8h]
