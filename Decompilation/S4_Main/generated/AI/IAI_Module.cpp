...
class CSolutionTree *  IAI_Module::ProblemSolve(int a2, class CParam * a3, class COptimizeOptions * a4) {
  ...
  for ( i = 0;
        i < CDynList::size(*((CDynList **)this + 1));
        ++i )
  {
...
double  IAI_Module::ValuationSubSolution(class CSolutionTree * a2, int a3, int a4) {
  ...
  if ( CDynList::isEmpty(*((CDynList **)a2 + 5)) )
  {
    return ((double (__thiscall *)(IAI_Module *, _DWORD, _DWORD, int, int))*(_DWORD *)(*(_DWORD *)this + 4))(this, *((_DWORD *)a2 + 4), *((_DWORD *)a2 + 3), a3, a4);
  }
  for ( i = 0;
        i < CDynList::size(*((CDynList **)a2 + 5));
        ++i )
  ...
  if ( a4 == 1 )
  {
    return ((double (__thiscall *)(IAI_Module *, _DWORD, _DWORD, int, int))*(_DWORD *)(*(_DWORD *)this + 4))(this, *((_DWORD *)a2 + 4), *((_DWORD *)a2 + 3), a3, 1) * v5;
  }
  else
  {
    return ((double (__thiscall *)(IAI_Module *, _DWORD, _DWORD, int, int))*(_DWORD *)(*(_DWORD *)this + 4))(this, *((_DWORD *)a2 + 4), *((_DWORD *)a2 + 3), a3, a4) + v5;
  }
}
