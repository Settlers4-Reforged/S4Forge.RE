...
// address=[0x14f35c0]
// Decompiled from _DWORD *__thiscall AdvXMLParser::Node::ConstIteratorRef::ConstIteratorRef(  _DWORD *this,  int a2,  char a3,  int a4,  int a5)
 AdvXMLParser::Node::ConstIteratorRef::ConstIteratorRef(class std::vector<class AdvXMLParser::Node *,class std::allocator<class AdvXMLParser::Node *> > const & a2, class std::_Vector_const_iterator<class std::_Vector_val<struct std::_Simple_types<class AdvXMLParser::Node *> > > a3) {
