...
public:
    // address=[0x2f16c30]
     CData(std::string const &);

    // address=[0x2f16cd0]
     CData(class AdvXMLParser::NodeContainer &,std::string const &);

    // address=[0x2f16d70]
    class AdvXMLParser::CData *  Clone(class AdvXMLParser::NodeContainer &)const;
    ...
    // address=[0x2f248a0]
    static class AdvXMLParser::CData * __cdecl Parse(class AdvXMLParser::Parser &,class AdvXMLParser::NodeContainer &);
