...
void __fastcall CS4MemChunk::SaveFuncSaveData(void const * a2, unsigned int Size) {
  ...
  if ( !this->m_pCurrent && BBSupportDbgReport(2, "LoadSave\\MemChunk.cpp", 321, "m_pCurrent != 0") == 1 )
    __debugbreak();
  if ( Size + (char *)this->m_pCurrent - (char *)this->m_pData > this->m_uSize
...
void __fastcall CS4MemChunk::SaveUnsigned32CalcSize(unsigned int a2) {
  ...
  if ( this->m_tMode != 2
    && BBSupportDbgReport(2, "LoadSave\\MemChunk.cpp", 346, "m_tMode == CHUNK_MODE_CALC_SIZE") == 1 )
  {
    __debugbreak();
  }
  this->m_uSize += 4;
...
unsigned int  CS4MemChunk::LoadUnsigned32Inline(void) {
  ...
  if ( this->m_tMode != 1
    && BBSupportDbgReport(2, "LoadSave\\MemChunk.cpp", 171, "m_tMode == CHUNK_MODE_LOAD_DATA") == 1 )
  {
    __debugbreak();
  }
