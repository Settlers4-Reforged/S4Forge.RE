...
// Decompiled from int __thiscall CWater::~CWater(CWater *this)
 CWater::~CWater(void) {
  ...
  if ( CWater::m_iInstanceCounter != 1 && BBSupportDbgReport(2, "Pathing\\WaterFlags.cpp", 889, "m_iInstanceCounter == 1") == 1 )
  {
    __debugbreak();
  }
  result = 0;
...
bool __cdecl CWater::MoveShip(int a1, int a2) {
  ...
  if ( !CShipMap::InShipList(a2) && BBSupportDbgReport(2, "Pathing\\WaterFlags.cpp", 1009, "g_cShipMap.InShipList(_iOldXY)") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( CShipMap::InShipList(a2) && BBSupportDbgReport(2, "Pathing\\WaterFlags.cpp", 1014, "!g_cShipMap.InShipList(_iOldXY)") == 1 )
  {
    __debugbreak();
  }
  if ( CWater::PlaceShip(a1) )
  {
    if ( !CShipMap::InShipList(a1) && BBSupportDbgReport(2, "Pathing\\WaterFlags.cpp", 1018, "g_cShipMap.InShipList(_iNewXY)") == 1 )
    {
      __debugbreak();
    }
    return 1;
  ...
  {
    if ( CShipMap::InShipList(a1) && BBSupportDbgReport(2, "Pathing\\WaterFlags.cpp", 1024, "!g_cShipMap.InShipList(_iNewXY)") == 1 )
    {
      __debugbreak();
    }
    if ( v3 )
    ...
    if ( !CShipMap::InShipList(a2) && BBSupportDbgReport(2, "Pathing\\WaterFlags.cpp", 1031, "g_cShipMap.InShipList(_iOldXY)") == 1 )
    {
      __debugbreak();
    }
    return 0;
