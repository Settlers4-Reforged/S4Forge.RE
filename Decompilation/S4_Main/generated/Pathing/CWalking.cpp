...
class CWalking * __cdecl CWalking::Create(std::istream &_rStream) {
  ...
  operator^<int>(_rStream, (int) &v20);
  v20 = 929995208;
  v24 = 1;
  operator^<short>(_rStream, &v24);
  if(v24 != 1) {
  ...
  v23 = -1;
  operator^<short>(_rStream, &v23);
  v21 = -1;
  operator^<int>(_rStream, (int) &v21);
  ...
  *((_DWORD *) Data + 11) = v21;
  ...
  operator^<int>(_rStream, (int) v3 + 4);
  v4 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v4 + 8);
  v5 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v5 + 12);
  v6 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v6 + 16);
  v7 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v7 + 20);
  v8 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v8 + 24);
  v9 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v9 + 28);
  v10 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v10 + 32);
  v11 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v11 + 36);
  v12 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v12 + 40);
  v13 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v13 + 48);
  v14 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v14 + 52);
  v15 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v15 + 56);
  v16 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v16 + 60);
  v17 = CWalkingBase::GetData(v22);
  operator^<int>(_rStream, (int) v17 + 64);
  v19 = 0;
  operator^<int>(_rStream, (int) &v19);
