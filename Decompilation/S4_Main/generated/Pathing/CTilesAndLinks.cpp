...
int __cdecl CTilesAndLinks::MoveLinkList(int _iDstLinksId, int _iSrcLinksId) {
  ...
  if ( _iDstLinksId >= _iSrcLinksId && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1127, "_iDstLinksId < _iSrcLinksId") == 1 )
  {
    __debugbreak();
  }
  if ( (_iDstLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1128, "(_iDstLinksId & 1) == 0") == 1 )
  {
    __debugbreak();
  }
  if ( (_iSrcLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1129, "(_iSrcLinksId & 1) == 0") == 1 )
  {
    __debugbreak();
  }
  v2 = CLinks::Link(_iDstLinksId);
  if ( !CLink::Unused(v2) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1130, "Link(_iDstLinksId).Unused()") == 1 )
  {
    __debugbreak();
  }
  v3 = CLinks::Link(_iSrcLinksId);
  if ( !CLink::IsHeader(v3) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1131, "Link(_iSrcLinksId).IsHeader()") == 1 )
  {
    __debugbreak();
  }
...
void __cdecl CTilesAndLinks::LinksGarbageCollection(int a1) {
  ...
  if ( CLinks::m_iMaxUsedLinksId < 2 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1157, "m_iMaxUsedLinksId >= LINK_FIRST_REAL") == 1 )
  {
    __debugbreak();
  }
  if ( CLinks::m_iMaxUsedLinksId > 262142 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1158, "m_iMaxUsedLinksId <= (LINK_LAST_REAL + 1)") == 1 )
  {
    __debugbreak();
  }
  if ( (CLinks::m_iMaxUsedLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1159, "(m_iMaxUsedLinksId & 1) == 0") == 1 )
  {
    __debugbreak();
  }
  v1 = CLinks::Link(CLinks::m_iMaxUsedLinksId);
  if ( CLink::Used(v1) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1160, "!Link(m_iMaxUsedLinksId).Used()") == 1 )
  {
    __debugbreak();
  }
  if ( CLinks::m_iMinFreeLinksId < 2 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1162, "m_iMinFreeLinksId >= LINK_FIRST_REAL") == 1 )
  {
    __debugbreak();
  }
  if ( CLinks::m_iMinFreeLinksId > 262142 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1163, "m_iMinFreeLinksId <= (LINK_LAST_REAL + 1)") == 1 )
  {
    __debugbreak();
  }
  if ( (CLinks::m_iMinFreeLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1164, "(m_iMinFreeLinksId & 1) == 0") == 1 )
  {
    __debugbreak();
  }
  v2 = CLinks::Link(CLinks::m_iMinFreeLinksId - 2);
  if ( !CLink::Used(v2) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1165, "Link(m_iMinFreeLinksId - 2).Used()") == 1 )
  {
    __debugbreak();
  }
  if ( CLinks::m_iMinFreeLinksId > CLinks::m_iMaxUsedLinksId && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1167, "m_iMinFreeLinksId <= m_iMaxUsedLinksId") == 1 )
  {
    __debugbreak();
  }
  while ( 1 )
  {
    ...
    for ( i = CLinks::m_iMaxUsedLinksId;
          ;
          i -= 2 )
    {
      v3 = CLinks::Link(i - 2);
    ...
    if ( CLinks::m_iMaxUsedLinksId < 2 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1192, "m_iMaxUsedLinksId >= LINK_FIRST_REAL") == 1 )
    {
      __debugbreak();
    }
    if ( CLinks::m_iMaxUsedLinksId > 262142 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1193, "m_iMaxUsedLinksId <= (LINK_LAST_REAL + 1)") == 1 )
    {
      __debugbreak();
    }
    if ( (CLinks::m_iMaxUsedLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1194, "(m_iMaxUsedLinksId & 1) == 0") == 1 )
    {
      __debugbreak();
    }
    v4 = CLinks::Link(CLinks::m_iMaxUsedLinksId - 2);
    if ( !CLink::Used(v4) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1195, "Link(m_iMaxUsedLinksId - 2).Used()") == 1 )
    {
      __debugbreak();
    }
    v5 = CLinks::Link(CLinks::m_iMaxUsedLinksId);
    if ( CLink::Used(v5) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1196, "!Link(m_iMaxUsedLinksId).Used()") == 1 )
    {
      __debugbreak();
    }
    for ( j = CLinks::m_iMinFreeLinksId;
          ;
          j += 2 )
    {
      v6 = CLinks::Link(j);
    ...
    if ( CLinks::m_iMinFreeLinksId < 2 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1216, "m_iMinFreeLinksId >= LINK_FIRST_REAL") == 1 )
    {
      __debugbreak();
    }
    if ( CLinks::m_iMinFreeLinksId > 262142 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1217, "m_iMinFreeLinksId <= (LINK_LAST_REAL + 1)") == 1 )
    {
      __debugbreak();
    }
    if ( (CLinks::m_iMinFreeLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1218, "(m_iMinFreeLinksId & 1) == 0") == 1 )
    {
      __debugbreak();
    }
    v7 = CLinks::Link(CLinks::m_iMinFreeLinksId - 2);
    if ( !CLink::Used(v7) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1219, "Link(m_iMinFreeLinksId - 2).Used()") == 1 )
    {
      __debugbreak();
    }
    v8 = CLinks::Link(CLinks::m_iMinFreeLinksId);
    if ( CLink::Used(v8) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1220, "!Link(m_iMinFreeLinksId).Used()") == 1 )
    {
      __debugbreak();
    }
    if ( CLinks::m_iMinFreeLinksId > CLinks::m_iMaxUsedLinksId && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1222, "m_iMinFreeLinksId <= m_iMaxUsedLinksId") == 1 )
    {
      __debugbreak();
    }
    for ( iLastHeaderLinksId = CLinks::m_iMaxUsedLinksId - 2;
          ;
          iLastHeaderLinksId -= 2 )
    {
    ...
    if ( iLastHeaderLinksId < 2 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1233, "iLastHeaderLinksId >= LINK_FIRST_REAL") == 1 )
    {
      __debugbreak();
    }
    ...
    if ( CLink::Used(v11) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1259, "!Link(m_iMaxUsedLinksId).Used()") == 1 )
    {
      __debugbreak();
    }
  }
  while ( 1 )
  {
    ...
    for ( k = CLinks::m_iMaxUsedLinksId;
          ;
          k -= 2 )
    {
      v12 = CLinks::Link(k - 2);
    ...
    if ( CLinks::m_iMaxUsedLinksId < 2 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1285, "m_iMaxUsedLinksId >= LINK_FIRST_REAL") == 1 )
    {
      __debugbreak();
    }
    if ( CLinks::m_iMaxUsedLinksId > 262142 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1286, "m_iMaxUsedLinksId <= (LINK_LAST_REAL + 1)") == 1 )
    {
      __debugbreak();
    }
    if ( (CLinks::m_iMaxUsedLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1287, "(m_iMaxUsedLinksId & 1) == 0") == 1 )
    {
      __debugbreak();
    }
    v13 = CLinks::Link(CLinks::m_iMaxUsedLinksId - 2);
    if ( !CLink::Used(v13) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1288, "Link(m_iMaxUsedLinksId - 2).Used()") == 1 )
    {
      __debugbreak();
    }
    v14 = CLinks::Link(CLinks::m_iMaxUsedLinksId);
    if ( CLink::Used(v14) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1289, "!Link(m_iMaxUsedLinksId).Used()") == 1 )
    {
      __debugbreak();
    }
    for ( m = CLinks::m_iMinFreeLinksId;
          ;
          m += 2 )
    {
      v15 = CLinks::Link(m);
    ...
    if ( CLinks::m_iMinFreeLinksId < 2 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1309, "m_iMinFreeLinksId >= LINK_FIRST_REAL") == 1 )
    {
      __debugbreak();
    }
    if ( CLinks::m_iMinFreeLinksId > 262142 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1310, "m_iMinFreeLinksId <= (LINK_LAST_REAL + 1)") == 1 )
    {
      __debugbreak();
    }
    if ( (CLinks::m_iMinFreeLinksId & 1) != 0 && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1311, "(m_iMinFreeLinksId & 1) == 0") == 1 )
    {
      __debugbreak();
    }
    v16 = CLinks::Link(CLinks::m_iMinFreeLinksId - 2);
    if ( !CLink::Used(v16) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1312, "Link(m_iMinFreeLinksId - 2).Used()") == 1 )
    {
      __debugbreak();
    }
    v17 = CLinks::Link(CLinks::m_iMinFreeLinksId);
    if ( CLink::Used(v17) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1313, "!Link(m_iMinFreeLinksId).Used()") == 1 )
    {
      __debugbreak();
    }
    if ( CLinks::m_iMinFreeLinksId > CLinks::m_iMaxUsedLinksId && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1315, "m_iMinFreeLinksId <= m_iMaxUsedLinksId") == 1 )
    {
      __debugbreak();
    }
    for ( iNextUsedLinksId = CLinks::m_iMinFreeLinksId;
          ;
          iNextUsedLinksId += 2 )
    {
    ...
    if ( !CLink::IsHeader(v19) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1326, "Link(iNextUsedLinksId).IsHeader()") == 1 )
    {
      __debugbreak();
    }
...
void __cdecl CTilesAndLinks::AddLink(int _iOwnerTileId, int _iLinkTileId) {
  ...
  if ( _iOwnerTileId == _iLinkTileId && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1401, "_iOwnerTileId != _iLinkTileId") == 1 )
  {
    __debugbreak();
  }
...
void __cdecl CTilesAndLinks::DeleteLink(int a1, int a2) {
  ...
  if ( !CTiles::IsValidRealTile(a2) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1485, "IsValidRealTile(_iLinkTileId)") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( !CLinks::IsValidUsedLinkList(v4) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1491, "IsValidUsedLinkList(rLinkList)") == 1 )
  {
    __debugbreak();
  }
...
void __cdecl CTilesAndLinks::ReplaceLink(int a1, int a2, int a3) {
  ...
  if ( !CLinks::LinkListReplaceLink(v4, a2, a3) )
  {
    ...
    if ( BBSupportDbgReport(1, "Pathing\\TilesAndLinks.cpp", 1467, "CTilesAndLinks::ReplaceLink(): OldLinkTileId not found [may be ignored]!") == 1 )
    {
      __debugbreak();
    }
...
void __cdecl CTilesAndLinks::AddLinkList(class CLinkList const & a1) {
  ...
  if ( !CLinks::IsValidUsedLinkList(a1) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1528, "IsValidUsedLinkList(_rLinkList)") == 1 )
  {
    __debugbreak();
  }
...
void __cdecl CTilesAndLinks::DeleteLinkList(class CLinkList & a1) {
  ...
  if ( !CLinks::IsValidUsedLinkList(a1) && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1506, "IsValidUsedLinkList(_rLinkList)") == 1 )
  {
    __debugbreak();
  }
  v3 = CLinkList::Size(a1);
...
void __cdecl CTilesAndLinks::MergeTileLinkLists(int _iDstTileId, int _iSrcTileId) {
  ...
  if ( _iDstTileId == _iSrcTileId && BBSupportDbgReport(2, "Pathing\\TilesAndLinks.cpp", 1575, "_iDstTileId != _iSrcTileId") == 1 )
  {
    __debugbreak();
  }
