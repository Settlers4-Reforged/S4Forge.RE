...
bool __cdecl CDebugFkt::SetDebugFuncKey(char const * String2, char a2) {
...
int (__cdecl*__cdecl CDebugFkt::SelectDebugFunc(char))(int a1, int a2) {
...
void __cdecl CDebugFkt::SetDebugString(class String const & a1) {
...
void __cdecl CDebugFkt::SetFrameCounter(float a1, float a2, float a3, float a4, float a5, float a6, float a7, unsigned int a8) {
  ...
  sprintf(Buffer, " - FPS: %3.2f Total: %3.0f%% Logic: %3.0f%% AI: %3.0f%% Script: %3.0f%% Tiling: %3.0f%% Animals: %3.0f%% NetSent: %d", a1, a2, a3, a4, a5, a6, a7, a8);
