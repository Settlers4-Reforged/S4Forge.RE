...
int  CDebitLevelManager::GetDebitValue(int a2, enum PILE_TYPES a3, bool a4, int a5) {
        ...
        ++i )
  {
    if ( *((_DWORD *)this + 10 * i) == a2 && *((_DWORD *)this + 10 * i + 1) == a3 && *((unsigned __int8 *)this + 40 * i + 8) == a4 )
    {
      ...
      if ( a5 < *((_DWORD *)this + 10 * i + 7) && CDebitLevelManager::DebitException(this, *((const struct type_info **)this + 10 * i + 8)) == (void *)1 )
      {
        return 0;
      }
    }
...
int  CDebitLevelManager::DebitPreCondition(int a2) {
  ...
  switch ( a2 )
  {
    case 0:
      ...
      break;
    case 2:
      if ( CSchedule::GetNumberOfBuildingTypeAtWork(*((_DWORD *)this + 201), 3) <= 1 || CSchedule::GetNumberOfBuildingTypeAtWork(*((_DWORD *)this + 201), 4) <= 1 )
      {
    ...
    case 8:
      ...
      break;
    case 9:
      if ( *(_DWORD *)(*((_DWORD *)this + 201) + 24) == 2 && CSchedule::GetNumberOfBuildingTypeAtWork(*((_DWORD *)this + 201), 37) > 0 )
      {
        result = 0;
      }
      else if ( *(_DWORD *)(*((_DWORD *)this + 201) + 24) || CSchedule::GetNumberOfBuildingTypeAtWork(*((_DWORD *)this + 201), 35) <= 0 )
      {
        ...
        {
          if ( *(_DWORD *)(*((_DWORD *)this + 201) + 24) != 4 || CSchedule::GetNumberOfBuildingTypeAtWork(*((_DWORD *)this + 201), 81) <= 0 )
          {
            goto CDebitLevelManager__DebitPreCondition___def_3358E0C;
          }
          result = 0;
      ...
      break;
    case 10:
      if ( CSchedule::GetNumberOfBuildingType(*((_DWORD *)this + 201), 44) <= 0 || CSchedule::GetNumberOfBuildingType(*((_DWORD *)this + 201), 43) <= 0 )
      {
        goto CDebitLevelManager__DebitPreCondition___def_3358E0C;
      }
      result = 0;
