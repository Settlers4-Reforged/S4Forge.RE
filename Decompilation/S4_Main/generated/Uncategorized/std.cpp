...
void  SIMPL_NS::EalStdAllocator<struct std::_Container_proxy,1111490559>::construct(struct std::_Container_proxy * a1, struct std::_Container_proxy const & a2) {
...
void  SIMPL_NS::EalStdAllocator<struct std::_Container_proxy,1111490559>::destroy(struct std::_Container_proxy * a1) {
