...
void  CEffect::InitEffect(int a2, enum SIV_SOUNDS a3, int a4, int a5, unsigned int a6, int a7, bool a8) {
...
void  CEffect::InitAngel(enum T_EFFECT_ANGEL a2, enum SIV_SOUNDS a3, int a4, int a5, int a6, unsigned int a7) {
...
void  CEffect::InitMissile(enum T_EFFECT_MISSILE a2, int a3, int a4, unsigned int a5, int a6, int a7) {
...
void  CEffect::InitSporeCloud(int a2, int a3, unsigned int a4) {
...
void  CEffect::InitMovingEffect(int a2, int a3, int a4) {
...
unsigned int  CEffect::SetNewDestinationForMovingEffect(int a2, int a3, int a4) {
...
void  CEffect::UpdateAttachedEffect(class CEffect const & a2) {
...
void  CEffect::InitAttachedEffect(int a2, unsigned int a3, class CEffect const & a4, int a5) {
...
void  CEffect::VisualizeEffect(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeAngel(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeArrow(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeCannonball(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeSporeCloud(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeStagnantAnimal(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeMovingEffect(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeTopEffect(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeTopFireball(struct SGfxObjectInfo & a2, int a3) {
...
void  CEffect::VisualizeAttachedEffect(struct SGfxObjectInfo & a2, int a3) {
