...
int CStatistic::DefenceStrength100Max(int _iPlayerId) const {
    ...
    if((_iPlayerId < 1 || _iPlayerId > 8) && BBSupportDbgReport(
                                                 2,
    ...
    return (100 * this->sPlayerStatistics[_iPlayerId].m_iDefenceStrength100) >> 8;
}
...
int CStatistic::OffenceStrength100Max(int _iPlayerId) const {
    ...
    return (100 * this->sPlayerStatistics[_iPlayerId].m_iOffenceStrength100) >> 8;
}
...
void CStatistic::Clear(void) {
    ...
    result = memset(this->sPlayerStatistics, 0, sizeof(this->sPlayerStatistics));
...
void CStatistic::Update(void) {
    ...
    if((int)g_pGameType->m_iTeamWon > 0 && !CStatistic::m_bWonStateSaved) {
        ...
        for(i = 0; i < 9; ++i)
            memcpy(
                this->sPlayerStatistics[i].m_iWinGoods,
                this->sPlayerStatistics[i].m_iNrOfGood,
                sizeof(this->sPlayerStatistics[i].m_iWinGoods));
    }
}
...
void CStatistic::Update(class CStatistic &a2) {
    ...
    memcpy(this->sPlayerStatistics, a2->sPlayerStatistics, 0x9A6Cu);
}
...
void CStatistic::Load(class IS4Chunk &a2) {
    ...
    for(i = 0; i < 9; ++i)
        a2->Load(&this->sPlayerStatistics[i], uStructSize);
    if(v3 >= 4)
...
void CStatistic::Save(class IS4Chunk &a2) {
    ...
    a2->Save(this->sPlayerStatistics, 0x9A68u);
...
void CStatistic::DecSettler(int _iPlayerId, int _iSettlerType) {
    ...
    if(this->sPlayerStatistics[_iPlayerId].m_iNrOfSettler[_iSettlerType] <= 0 && BBSupportDbgReport(
                                                                                     2,
                                                                                     "Logic\\Statistic.cpp",
                                                                                     331,
    ...
    if(this->sPlayerStatistics[_iPlayerId].m_iTotalNrOfSettler <= 0 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 332, "m_sPlayerStats[_iPlayerId].m_iTotalNrOfSettler > 0") == 1) {
        __debugbreak();
    }
    if(this->sPlayerStatistics[_iPlayerId].m_iNrOfSettler[_iSettlerType] > 0)
        --this->sPlayerStatistics[_iPlayerId].m_iNrOfSettler[_iSettlerType];
    if(this->sPlayerStatistics[_iPlayerId].m_iTotalNrOfSettler > 0)
        --this->sPlayerStatistics[_iPlayerId].m_iTotalNrOfSettler;
    switch(CSettlerMgr::SettlerWarriorType(_iSettlerType)) {
    case 0:
        if(this->sPlayerStatistics[_iPlayerId].m_iNrOfCivilian <= 0 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 369, "m_sPlayerStats[_iPlayerId].m_iNrOfCivilian > 0") == 1) {
            __debugbreak();
        }
        if(this->sPlayerStatistics[_iPlayerId].m_iNrOfCivilian > 0)
            --this->sPlayerStatistics[_iPlayerId].m_iNrOfCivilian;
        break;
    case 1:
    case 6:
    case 7:
    case 14:
        return;
    default:
        if(this->sPlayerStatistics[_iPlayerId].m_iNrOfSoldier <= 0 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 380, "m_sPlayerStats[_iPlayerId].m_iNrOfSoldier > 0") == 1) {
            __debugbreak();
        }
        if(this->sPlayerStatistics[_iPlayerId].m_iNrOfSoldier > 0)
            --this->sPlayerStatistics[_iPlayerId].m_iNrOfSoldier;
        break;
    }
}
...
void CStatistic::AddSettler(int a2, int _iSettlerType) {
    ...
    ++this->sPlayerStatistics[a2].m_iNrOfSettler[_iSettlerType];
    ++this->sPlayerStatistics[a2].m_iTotalNrOfSettler;
    switch(CSettlerMgr::SettlerWarriorType(_iSettlerType)) {
    case 0:
        ++this->sPlayerStatistics[a2].m_iNrOfCivilian;
        break;
    case 1:
    case 6:
    case 7:
    case 14:
        return;
    default:
        ++this->sPlayerStatistics[a2].m_iNrOfSoldier;
        break;
    }
}
...
int CStatistic::GetSettler(int _iPlayerId, int _iSettlerType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfSettler[_iSettlerType];
}
...
int CStatistic::GetTotalSettler(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iTotalOfSettler[SETTLER_CARRIER];
}
...
int CStatistic::GetCivilian(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iNrOfCivilian;
}
...
int CStatistic::GetSoldiers(int _iPlayerId) const {
    ...
    for(i = 0; i < 67; ++i) {
        ...
        if(v4 > 0 && v4 <= 6)
            v5 += this->sPlayerStatistics[_iPlayerId].m_iTotalOfSettler[i];
    }
    return v5;
}
...
int CStatistic::GetNrOfSoldiers(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iNrOfSoldier;
}
...
void CStatistic::AddProducedSettler(int a2, int _iSettlerType) {
    ...
    ++this->sPlayerStatistics[a2].m_iTotalOfSettler[_iSettlerType];
    ++this->sPlayerStatistics[a2].m_iProducedSettlers;
}
...
int CStatistic::GetProducedSettler(int _iPlayerId, int _iSettlerType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalOfSettler[_iSettlerType];
}
...
int CStatistic::GetTotalProducedSettler(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iProducedSettlers;
}
...
int CStatistic::GetBuildingProductivity(int _iPlayerId, int _iBuildingType) const {
    ...
    return (unsigned __int8)this->sPlayerStatistics[_iPlayerId].m_iTotalUsedBuildingMaterial[_iBuildingType + 4];
}
...
void CStatistic::AddBuilding(int a2, int a3, int a4) {
    ...
    this->sPlayerStatistics[a2].m_iNrOfBuilding[a3] += a4;
    this->sPlayerStatistics[a2].m_iTotalOfBuilding += a4;
...
void CStatistic::DecBuilding(int _iPlayerId, int _iBuildingType, int a4) {
    ...
    if(this->sPlayerStatistics[_iPlayerId].m_iNrOfBuilding[_iBuildingType] < a4 && BBSupportDbgReport(
                                                                                       2,
                                                                                       "Logic\\Statistic.cpp",
                                                                                       555,
    ...
    this->sPlayerStatistics[_iPlayerId].m_iTotalOfBuilding -= a4;
    this->sPlayerStatistics[_iPlayerId].m_iNrOfBuilding[_iBuildingType] -= a4;
...
int CStatistic::GetBuildings(int _iPlayerId, int _iBuildingType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfBuilding[_iBuildingType];
}
...
void CStatistic::AddProducedBuilding(int a2, int a3, int a4) {
    ...
    if(a3 >= 83 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 611, "_iBuilding < BUILDING_MAX") == 1)
        __debugbreak();
    this->sPlayerStatistics[a2].m_iNrOfProducedBuilding[a3] += a4;
    this->sPlayerStatistics[a2].m_iProducedBuildings += a4;
}
...
int CStatistic::GetProducedBuildings(int _iPlayerId, int _iBuilding) const {
    ...
    if(_iBuilding >= 83 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 625, "_iBuilding < BUILDING_MAX") == 1)
        __debugbreak();
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedBuilding[_iBuilding];
}
...
int CStatistic::GetTotalBuildings(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iTotalOfBuilding;
}
...
int CStatistic::GetTotalProducedBuildings(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iProducedBuildings;
}
...
void CStatistic::AddCaptureBuilding(int _iPlayer, int _iTarget, int _iBuilding) {
    ...
    ++this->sPlayerStatistics[_iPlayer].m_iNrOfCapturedBuilding[_iBuilding];
    ++this->sPlayerStatistics[_iTarget].m_iNrOfLostBuilding[_iBuilding];
}
...
int CStatistic::GetCapturedTowers(int _iPlayer) {
    ...
    return this->sPlayerStatistics[_iPlayer].m_iNrOfCapturedBuilding[48] + this->sPlayerStatistics[_iPlayer].m_iNrOfCapturedBuilding[47] + this->sPlayerStatistics[_iPlayer].m_iNrOfCapturedBuilding[46];
}
...
int CStatistic::GetLossesTowers(int a2) {
    ...
    return this->sPlayerStatistics[a2].m_iNrOfLostBuilding[BUILDING_CASTLE] + this->sPlayerStatistics[a2].m_iNrOfLostBuilding[BUILDING_GUARDTOWERBIG] + this->sPlayerStatistics[a2].m_iNrOfLostBuilding[BUILDING_GUARDTOWERSMALL];
}
...
void CStatistic::AddConstruction(int _iPlayerId, int _iBuildingType, int _iCount) {
    ...
    this->sPlayerStatistics[_iPlayerId].m_iNrOfBuildingSites[_iBuildingType] += _iCount;
    this->sPlayerStatistics[_iPlayerId].m_iTotalBuildingSites += _iCount;
}
...
void CStatistic::DecConstruction(int _iPlayerId, int _iBuildingType, int a4) {
    ...
    if(this->sPlayerStatistics[_iPlayerId].m_iNrOfBuildingSites[_iBuildingType] < a4 && BBSupportDbgReport(
                                                                                            2,
                                                                                            "Logic\\Statistic.cpp",
                                                                                            661,
    ...
    this->sPlayerStatistics[_iPlayerId].m_iNrOfBuildingSites[_iBuildingType] -= a4;
    this->sPlayerStatistics[_iPlayerId].m_iTotalBuildingSites -= a4;
}
...
int CStatistic::GetConstructions(int _iPlayerId, int _iBuildingType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfBuildingSites[_iBuildingType];
}
...
void CStatistic::ChangeResidenceNeed(int _iPlayerId, int _iCount) {
    ...
    this->sPlayerStatistics[_iPlayerId].m_iResidenceNeed += _iCount;
}
...
int CStatistic::GetResidenceNeed(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iNrOfSettler[1];
}
...
void CStatistic::ChangeResidenceSpace(int a2, int a3) {
    ...
    this->sPlayerStatistics[a2].m_iResidenceSpace += a3;
}
...
void CStatistic::AddGood(int _iPlayerId, int _iGood, int a4) {
    ...
    if(_iGood >= GOOD_MAX && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 163, "_iGood < GOOD_MAX") == 1)
        __debugbreak();
    this->sPlayerStatistics[_iPlayerId].m_iNrOfGood[_iGood] += a4;
    this->sPlayerStatistics[_iPlayerId].m_iTotalGoods += a4;
    if(!CStatistic::m_bWonStateSaved)
        this->sPlayerStatistics[_iPlayerId].m_iWinGoods[_iGood] = this->sPlayerStatistics[_iPlayerId].m_iNrOfGood[_iGood];
}
...
void CStatistic::DecGood(int _iPlayerId, int _iGood, int _iCount) {
    ...
    if(_iGood >= 43 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 184, "_iGood < GOOD_MAX") == 1)
        __debugbreak();
    v4 = _iCount;
    if(this->sPlayerStatistics[_iPlayerId].m_iNrOfGood[_iGood] < _iCount)
        v4 = this->sPlayerStatistics[_iPlayerId].m_iNrOfGood[_iGood];
    this->sPlayerStatistics[_iPlayerId].m_iNrOfGood[_iGood] -= v4;
    this->sPlayerStatistics[_iPlayerId].m_iTotalGoods -= v4;
}
...
int CStatistic::GetGood(int _iPlayerId, int _iGood) const {
    ...
    if(_iGood >= 43 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 203, "_iGood < GOOD_MAX") == 1)
        __debugbreak();
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfGood[_iGood];
}
...
int CStatistic::GetWinGood(int _iPlayerId, int _iGood) const {
    ...
    if(_iGood >= 43 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 211, "_iGood < GOOD_MAX") == 1)
        __debugbreak();
    return this->sPlayerStatistics[_iPlayerId].m_iWinGoods[_iGood];
}
...
int CStatistic::GetTotalGood(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalGoods;
}
...
void CStatistic::AddProducedGoods(int _iPlayerId, int _iGood, int _iCount) {
    ...
    if(_iGood >= 43 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 236, "_iGood < GOOD_MAX") == 1)
        __debugbreak();
    this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedGoods[_iGood] += _iCount;
    this->sPlayerStatistics[_iPlayerId].m_iTotalProducedGoods += _iCount;
}
...
int CStatistic::GetProducedGoods(int _iPlayerId, int _iGood) const {
    ...
    if(_iGood >= 43 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 250, "_iGood < GOOD_MAX") == 1)
        __debugbreak();
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedGoods[_iGood];
}
...
int CStatistic::GetTotalProducedGood(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalProducedGoods;
}
...
void CStatistic::AddVehicle(int _iPlayerId, int _iVehicleType, int _iCount) {
    ...
    if(_iVehicleType >= 6 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 760, "_iVehicleType < VEHICLE_MAX") == 1)
        __debugbreak();
    this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicle[_iVehicleType] += _iCount;
    this->sPlayerStatistics[_iPlayerId].m_iTotalVehicles += _iCount;
}
...
void CStatistic::DecVehicle(int _iPlayerId, int _iVehicleType, int _iCount) {
    ...
    v4 = _iCount;
    if(this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicle[_iVehicleType] < _iCount)
        v4 = this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicle[_iVehicleType];
    this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicle[_iVehicleType] -= v4;
    this->sPlayerStatistics[_iPlayerId].m_iTotalVehicles -= v4;
}
...
int CStatistic::GetVehicle(int a2, int a3) const {
    ...
    return this->sPlayerStatistics[a2].m_iNrOfVehicle[a3];
}
...
int CStatistic::GetTotalVehicle(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalVehicles;
}
...
void CStatistic::AddProducedVehicle(int _iPlayerId, int _iVehicleType, int _iCount) {
    ...
    this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedVehicle[_iVehicleType] += _iCount;
    this->sPlayerStatistics[_iPlayerId].m_iTotalProducedVehicles += _iCount;
}
...
int CStatistic::GetProducedVehicle(int _iPlayerId, int _iVehicleType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedVehicle[_iVehicleType];
}
...
int CStatistic::GetTotalProducedVehicled(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalProducedVehicles;
}
...
int CStatistic::GetMana(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iMana;
}
...
int CStatistic::GetProducedMana(int _iPlayerId) const {
    ...
    if((_iPlayerId <= 0 || _iPlayerId >= 9) && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 1116, "_iPlayerId > 0 && _iPlayerId < PLAYER_MAX") == 1) {
        __debugbreak();
    }
    return this->sPlayerStatistics[_iPlayerId].m_iProducedMana;
}
...
void CStatistic::IncKillsOfType(int _iPlayerId, int _iSettlerType) {
    ...
    if(_iSettlerType <= 0 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 864, "_iSettlerType > 0") == 1)
        __debugbreak();
    if(_iSettlerType < 67) {
        ++this->sPlayerStatistics[_iPlayerId].m_iNrOfKill[_iSettlerType];
        ++this->sPlayerStatistics[_iPlayerId].m_iTotalKills;
    }
}
...
int CStatistic::GetKillsOfType(int _iPlayerId, int _iSettlerType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfKill[_iSettlerType];
}
...
int CStatistic::GetKills(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalKills;
}
...
void CStatistic::IncLossesOfType(int _iPlayerId, int _iSettlerType) {
    ...
    if(_iSettlerType <= 0 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 900, "_iSettlerType > 0") == 1)
        __debugbreak();
    if(_iSettlerType < 67) {
        ++this->sPlayerStatistics[_iPlayerId].m_iNrOfLoss[_iSettlerType];
        ++this->sPlayerStatistics[_iPlayerId].m_iTotalLosses;
    }
}
...
int CStatistic::GetLossesOfType(int _iPlayerId, int _iSettlerType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfLoss[_iSettlerType];
}
...
int CStatistic::GetLosses(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalLosses;
}
...
void CStatistic::IncKillsVehicleOfType(int _iPlayerId, int _iVehicleType) {
    ...
    ++this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicleKill[_iVehicleType];
    ++this->sPlayerStatistics[_iPlayerId].m_iTotalVehicleKills;
}
...
int CStatistic::GetKillsVehicleOfType(int _iPlayerId, int _iVehicleType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicleKill[_iVehicleType];
}
...
int CStatistic::GetKillsVehicle(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalVehicleKills;
}
...
void CStatistic::IncLossesVehicleOfType(int _iPlayerId, int _iVehicleType) {
    ...
    ++this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicleLoss[_iVehicleType];
    ++this->sPlayerStatistics[_iPlayerId].m_iTotalVehicleLosses;
}
...
int CStatistic::GetLossesVehicleOfType(int _iPlayerId, int _iVehicleType) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfVehicleLoss[_iVehicleType];
}
...
int CStatistic::GetLossesVehicle(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalVehicleLosses;
}
...
void CStatistic::IncBuildingLosses(int _iPlayerId) {
    ...
    ++this->sPlayerStatistics[_iPlayerId].m_iTotalBuildingLosses;
}
...
int CStatistic::GetBuildingLosses(int _iPlayerId) {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalBuildingLosses;
}
...
int CStatistic::GetLandSize(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iLandSize;
}
...
int CStatistic::GetMaxLandSize(int a2) const {
    ...
    return this->sPlayerStatistics[a2].m_iMaxLandSize;
}
...
void CStatistic::SetOffenceStrength100(int a2, int a3) {
    ...
    if(a2 >= 1 && a2 < 9) {
        ...
        if(a3 > 0) {
            ...
            if(iOffenceStrengthBase256 >= this->sPlayerStatistics[a2].m_iOffenceStrengthBase256) {
                if(iOffenceStrengthBase256 > 384)
                    iOffenceStrengthBase256 = 384;
            } else {
                iOffenceStrengthBase256 = this->sPlayerStatistics[a2].m_iOffenceStrengthBase256;
            }
        }
        this->sPlayerStatistics[a2].m_iOffenceStrength100_2 = iOffenceStrengthBase256;
        CStatistic::SPlayerStatistic::CalculateFightingStrength(&this->sPlayerStatistics[a2], a2);
    }
}
...
int CStatistic::UsedBuildingMaterial(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iTotalUsedBuildingMaterial;
}
...
int CStatistic::GetTotalTowers(int _iPlayerId) {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedBuilding[BUILDING_CASTLE] + this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedBuilding[BUILDING_GUARDTOWERBIG] + this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedBuilding[BUILDING_GUARDTOWERSMALL];
}
...
int CStatistic::GetTotalMineProduction(int a2) {
    ...
    return this->sPlayerStatistics[a2].m_iNrOfProducedGoods[GOOD_IRONORE] + this->sPlayerStatistics[a2].m_iNrOfProducedGoods[GOOD_SULFUR] + this->sPlayerStatistics[a2].m_iNrOfProducedGoods[GOOD_GOLDORE] + this->sPlayerStatistics[a2].m_iNrOfProducedGoods[GOOD_COAL];
}
...
int CStatistic::GetTotalFood(int _iPlayerId) {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedGoods[GOOD_MEAT] + this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedGoods[GOOD_FISH] + this->sPlayerStatistics[_iPlayerId].m_iNrOfProducedGoods[GOOD_BREAD];
}
...
void CStatistic::SetPlayerExitTime(int _iPlayerId, unsigned int _iExitTime) {
    ...
    this->sPlayerStatistics[_iPlayerId].m_iExitTime = _iExitTime;
}
...
unsigned int CStatistic::GetPlayerExitTime(int _iPlayerId) {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iExitTime;
}
...
void CStatistic::UpdateStartStatistic(void) {
    ...
    for(i = 1; i <= 8; ++i) {
        for(j = 0; j < SETTLER_MAX; ++j) {
            this->sPlayerStatistics[i].m_iTotalOfSettler[j] = this->sPlayerStatistics[i].m_iNrOfSettler[j];
            this->sPlayerStatistics[i].m_iProducedSettlers += this->sPlayerStatistics[i].m_iNrOfSettler[j];
        }
        for(k = 0; k < BUILDING_MAX; ++k) {
            this->sPlayerStatistics[i].m_iNrOfProducedBuilding[k] = this->sPlayerStatistics[i].m_iNrOfBuilding[k];
            this->sPlayerStatistics[i].m_iProducedBuildings += this->sPlayerStatistics[i].m_iNrOfBuilding[k];
        }
        for(m = 0; m < 6; ++m) {
            this->sPlayerStatistics[i].m_iNrOfProducedVehicle[m] = this->sPlayerStatistics[i].m_iNrOfVehicle[m];
            this->sPlayerStatistics[i].m_iTotalProducedVehicles += this->sPlayerStatistics[i].m_iNrOfVehicle[m];
        }
        for(n = 0; n < GOOD_MAX; ++n) {
            this->sPlayerStatistics[i].m_iNrOfProducedGoods[n] = this->sPlayerStatistics[i].m_iNrOfGood[n];
            this->sPlayerStatistics[i].m_iTotalProducedGoods += this->sPlayerStatistics[i].m_iNrOfGood[n];
        }
    }
}
...
int CStatistic::DefenceStrength100(int _iPlayerId) const {
    ...
    return (100 * this->sPlayerStatistics[_iPlayerId].m_iEffectiveDefenceStrength256) >> 8;
}
...
int CStatistic::OffenceStrength100(int _iPlayerId) const {
    ...
    return (100 * this->sPlayerStatistics[_iPlayerId].m_iEffectiveOffenceStrength256) >> 8;
}
...
int CStatistic::DefenceStrength256(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iEffectiveDefenceStrength256;
}
...
int CStatistic::OffenceStrength256(int _iPlayerId) const {
    ...
    return this->sPlayerStatistics[_iPlayerId].m_iEffectiveOffenceStrength256;
}
    ...
    if(iNumberOfPlayers > 0) {
        ...
        for(i = 1; i < iNumberOfPlayers + 1; ++i) {
            if(CPlayerManager::Race(i) == 3)
                this->sPlayerStatistics[i].m_iOffenceStrengthBase256 = 256;
            else
                this->sPlayerStatistics[i].m_iOffenceStrengthBase256 = iOffenceStrengthBase256;
            CStatistic::SPlayerStatistic::CalculateFightingStrength(&this->sPlayerStatistics[i], i);
        }
    }
}
...
void CStatistic::UpdateFightingStrength(int _iPlayerId, int _iRace, int _iBuildingType, int a5) {
    ...
    if(_iRace > 4 && BBSupportDbgReport(2, "Logic\\Statistic.cpp", 1412, "(_iRace >= 0) && (_iRace < RACE_MAX)") == 1)
        __debugbreak();
    if((_iBuildingType <= BUILDING_NO_BUILDING || _iBuildingType >= BUILDING_MAX) && BBSupportDbgReport(
                                                                                         2,
                                                                                         "Logic\\Statistic.cpp",
                                                                                         1413,
    ...
    if(_iBuildingType < BUILDING_EYECATCHER01 || _iBuildingType > BUILDING_EYECATCHER12)
        CStatistic::SPlayerStatistic::UpdateFightingStrength(
            &this->sPlayerStatistics[_iPlayerId],
            _iPlayerId,
...
void CStatistic::CalculateLandSize(void) {
    ...
    PlayerId = CPlayerManager::LastPlayerId();
    for(i = 1; i <= PlayerId; ++i) {
        this->sPlayerStatistics[i].m_iLandSize = g_pTiling->NumberOfOwnedLandElements(g_pTiling, i);
        v1 = 100 * this->sPlayerStatistics[i].m_iLandSize;
        this->sPlayerStatistics[i].m_iLandSize = v1 / g_pTiling->NumberOfLandElements(g_pTiling);
        this->sPlayerStatistics[i].m_iMaxLandSize = *(_DWORD *)std::max<long>(
            &this->sPlayerStatistics[i].m_iMaxLandSize,
            &this->sPlayerStatistics[i].m_iLandSize);
    }
}
...
void CStatistic::CalculateMana(void) {
    ...
    PlayerId = CPlayerManager::LastPlayerId();
    for(i = 1; i <= PlayerId; ++i) {
        this->sPlayerStatistics[i].m_iMana = CMagic::GetCurrentManaAmount(i);
        this->sPlayerStatistics[i].m_iProducedMana = CMagic::TotalAmountOfCollectedMana(i);
    }
}
