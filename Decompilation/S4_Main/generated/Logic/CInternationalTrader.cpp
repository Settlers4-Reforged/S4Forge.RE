...
void  CInternationalTrader::SetGoodStatus(int a1, class CBuilding * a2, enum PILE_TYPES a3, enum TGOOD_STATUS a4) {
  ...
  if ( (a1 <= 0 || a1 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 471, "_iPlayerID > 0 && _iPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
  result = 0;
...
void  CInternationalTrader::SwitchToNextGoodStatus(int a2, class CBuilding * a3, enum PILE_TYPES a4) {
  ...
  if ( (a2 <= 0 || a2 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 490, "_iPlayerID > 0 && _iPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
  result = 0;
...
void  CInternationalTrader::SwitchPlayerTradeStatus(int a2, int a3) {
  ...
  if ( (a3 < 0 || a3 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 415, "_iPlayerID>=0 && _iPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
  if ( (a2 < 0 || a2 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 416, "_iForPlayerID>=0 && _iForPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
...
void  CInternationalTrader::SetPlayerTradeStatus(int a2, int a3, bool a4) {
  ...
  if ( (a3 < 0 || a3 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 404, "_iWithPlayerID>=0 && _iWithPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
  if ( (a2 < 0 || a2 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 405, "iForPlayerID>=0 && iForPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
...
bool  CInternationalTrader::GetPlayerTradeStatus(int a2, int a3) {
  ...
  if ( (a2 < 0 || a2 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 423, "_iPlayerID>=0 && _iPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
  if ( (a3 < 0 || a3 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 424, "_OtherPlayerID>=0 && _OtherPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
  v3 = (CInternationalTrader::CPlayerTradeInfo **)std::vector<CInternationalTrader::CPlayerTradeInfo *>::operator[](a2);
...
bool  CInternationalTrader::TradeWithSomeone(int a2) {
  ...
  if ( (a2 < 0 || a2 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 431, "_iPlayerID>=0 && _iPlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
...
bool  CInternationalTrader::CheckGoodMatch(int a2, int a3, enum PILE_TYPES a4) {
  ...
  while ( 1 )
  {
    ...
    v16 = *(_DWORD *)(std::_Vector_iterator<std::_Vector_val<std::_Simple_types<CInternationalTrader::CPlayerTradeInfo::TGoodInfo>>>::operator*(v9) + 4);
    if ( v16 == a4 )
    {
...
enum TGOOD_STATUS  CInternationalTrader::GetGoodStatus(int a1, class CBuilding * a2, enum PILE_TYPES a3) {
  ...
  if ( (a1 <= 0 || a1 > CPlayerManager::NumberOfPlayers()) && BBSupportDbgReport(2, "Logic\\InternationalTrader.cpp", 506, "_PlayerID > 0 && _PlayerID<=g_cPlayerMgr.NumberOfPlayers()") == 1 )
  {
    __debugbreak();
  }
