...
void  CBlitFX::SetFillColor(int a2, int a3, int a4, bool a5) {
  ...
  if ( a5 )
  {
    v5 = 32 * (unsigned __int16)(int)(float)((float)a3 * 0.12156863) + ((unsigned __int16)(int)(float)((float)a2 * 0.12156863) << 10);
  }
  else
  {
    v5 = 32 * (unsigned __int16)(int)(float)((float)a3 * 0.24705882) + ((unsigned __int16)(int)(float)((float)a2 * 0.12156863) << 11);
  }
...
void  CBlitFX::SetFillColorAlpha(int a2, int a3, int a4, int a5) {
  ...
  *((_DWORD *)this + 20) = result + 16 * (unsigned __int16)(int)(float)((float)a3 * 0.05882353) + ((unsigned __int16)(int)(float)((float)a2 * 0.05882353) << 8) + ((unsigned __int16)(int)(float)((float)a5 * 0.05882353) << 12);
  return result;
}
