...
// address=[0x129e960]
_png_do_read_interlace_c;

// address=[0x129eda0]
_png_read_filter_row_c;
...
// address=[0x12a7ca0]
_png_read_filter_row_mmx_avg;

// address=[0x12a8160]
_png_read_filter_row_mmx_paeth;

// address=[0x12a8a00]
_png_read_filter_row_mmx_sub;

// address=[0x12a8d50]
_png_read_filter_row_mmx_up;
...
// address=[0x145ff00]
public: __thiscall TheAllocator<class TSparseMap<unsigned char>::TNode>::TheAllocator<class TSparseMap<unsigned char>::TNode>(unsigned int,bool);

// address=[0x1460120]
public: __thiscall TheAllocator<class TSparseMap<unsigned char>::TNode>::~TheAllocator<class TSparseMap<unsigned char>::TNode>(void);
...
// address=[0x3665050]
void __cdecl `private: static class TheAllocator<class TSparseMap<unsigned char>::TNode> & __cdecl TSparseMap<unsigned char>::TNode::_allocator(void)'::`2'::`dynamic atexit destructor for 'm_allocator''(void);
...
// address=[0x3f1f77c]
class TheAllocator<class TSparseMap<unsigned char>::TNode> `private: static class TheAllocator<class TSparseMap<unsigned char>::TNode> & __cdecl TSparseMap<unsigned char>::TNode::_allocator(void)'::`2'::m_allocator;

// address=[0x3f1f798]
int `private: static class TheAllocator<class TSparseMap<unsigned char>::TNode> & __cdecl TSparseMap<unsigned char>::TNode::_allocator(void)'::`2'::$TSS0;
...
// address=[0x473500c]
__imp__StartTraceA@12;

// address=[0x4735010]
__imp__ControlTraceA@20;
...
// address=[0x473501c]
__imp__ProcessTrace@16;

// address=[0x4735020]
__imp__RegisterEventSourceW@8;
...
// address=[0x473503c]
__imp__CryptAcquireContextW@20;

// address=[0x4735040]
ADVAPI32_NULL_THUNK_DATA;

// address=[0x4735078]
__imp__CertGetCertificateContextProperty@16;

// address=[0x473507c]
__imp__CertFreeCertificateContext@4;

// address=[0x4735080]
__imp__CertEnumCertificatesInStore@8;
...
// address=[0x47350f0]
__imp__DirectSoundEnumerateA@8;
...
// address=[0x4735140]
__imp__GetTextExtentPoint32A@16;
...
// address=[0x47351a0]
__imp__CancelMibChangeNotify2@4;

// address=[0x47351a4]
__imp__GetIpAddrTable@12;

// address=[0x47351a8]
__imp__GetAdaptersInfo@8;

// address=[0x47351ac]
__imp__GetUnicastIpAddressEntry@4;

// address=[0x47351b0]
__imp__GetUnicastIpAddressTable@8;

// address=[0x47351b4]
__imp__NotifyUnicastIpAddressChange@20;

// address=[0x47351b8]
__imp__GetBestRoute@12;

// address=[0x47351bc]
__imp__FreeMibTable@4;

// address=[0x47351c0]
__imp__GetIfEntry@4;

// address=[0x47351c4]
__imp__GetBestInterface@8;
...
// address=[0x47352b0]
__imp__UnregisterWait@4;

// address=[0x47352b4]
__imp__RegisterWaitForSingleObject@24;
...
// address=[0x47352c0]
__imp__DeleteTimerQueueTimer@12;

// address=[0x47352c4]
__imp__ChangeTimerQueueTimer@16;

// address=[0x47352c8]
__imp__CreateTimerQueueTimer@28;
...
// address=[0x4735380]
__imp__HeapQueryInformation@20;
...
// address=[0x4735488]
__imp__GetUserPreferredUILanguages@16;

// address=[0x473548c]
__imp__GetLocaleInfoEx@16;
...
// address=[0x47354ac]
__imp__VerSetConditionMask@16;

// address=[0x47354b0]
__imp__VerifyVersionInfoA@16;
...
// address=[0x4735530]
__imp__RtlCaptureStackBackTrace@16;
...
// address=[0x4735610]
__imp__CreateErrorInfo@4;

// address=[0x4735614]
__imp__SetErrorInfo@8;
...
// address=[0x473568c]
__imp__SetWindowPos@28;

// address=[0x4735690]
__imp__DialogBoxParamA@20;

// address=[0x4735694]
__imp__GetWindowLongA@8;

// address=[0x4735698]
__imp__SetWindowLongA@12;
...
// address=[0x47356a4]
__imp__ScreenToClient@8;

// address=[0x47356a8]
__imp__OffsetRect@12;

// address=[0x47356ac]
__imp__MonitorFromWindow@8;

// address=[0x47356b0]
__imp__GetMonitorInfoA@8;
...
// address=[0x47356bc]
__imp__LoadImageA@24;

// address=[0x47356c0]
__imp__EndDialog@8;

// address=[0x47356c4]
__imp__SetDlgItemTextA@12;
...
// address=[0x47356f4]
__imp__GetWindowInfo@8;

// address=[0x47356f8]
__imp__ClientToScreen@8;

// address=[0x47356fc]
__imp__SetCursorPos@8;
...
// address=[0x473573c]
__imp__SetClassLongA@12;

// address=[0x4735740]
__imp__LoadBitmapA@8;
...
// address=[0x473574c]
__imp__EmptyClipboard@0;

// address=[0x4735750]
__imp__CloseClipboard@0;

// address=[0x4735754]
__imp__OpenClipboard@4;

// address=[0x4735758]
__imp__wsprintfW;

// address=[0x473575c]
__imp__GetClipboardData@4;
...
// address=[0x4735768]
__imp__GetLastActivePopup@4;

// address=[0x473576c]
__imp__GetActiveWindow@0;
...
// address=[0x47357dc]
__imp__GetFileVersionInfoSizeW@8;

// address=[0x47357e0]
__imp__VerQueryValueW@16;

// address=[0x47357e4]
__imp__GetFileVersionInfoW@16;

// address=[0x47357e8]
VERSION_NULL_THUNK_DATA;

// address=[0x4735814]
__imp__mixerSetControlDetails@12;

// address=[0x4735818]
__imp__mixerGetControlDetailsA@12;

// address=[0x473581c]
__imp__mixerGetLineControlsA@12;

// address=[0x4735820]
__imp__timeBeginPeriod@4;
...
// address=[0x473582c]
__imp__mixerGetDevCapsA@12;

// address=[0x4735830]
__imp__mixerGetNumDevs@0;

// address=[0x4735834]
__imp__timeEndPeriod@4;

// address=[0x4735838]
__imp__mixerGetLineInfoA@12;
...
// address=[0x4735880]
__imp__WSACreateEvent@0;

// address=[0x4735884]
__imp__WSACloseEvent@4;
...
// address=[0x4735890]
__imp__WSAResetEvent@4;

// address=[0x4735894]
__imp__WSARecvFrom@36;

// address=[0x4735898]
__imp__WSAGetOverlappedResult@20;

// address=[0x473589c]
__imp__WSAEventSelect@12;
...
// address=[0x4735980]
__imp__BCryptHashData@16;

// address=[0x4735984]
__imp__BCryptOpenAlgorithmProvider@16;

// address=[0x4735988]
__imp__BCryptGetProperty@24;

// address=[0x473598c]
__imp__BCryptFinishHash@16;

// address=[0x4735990]
__imp__BCryptSetProperty@20;

// address=[0x4735994]
__imp__BCryptCloseAlgorithmProvider@8;

// address=[0x4735998]
__imp__BCryptGenerateSymmetricKey@28;

// address=[0x473599c]
__imp__BCryptGenerateKeyPair@16;

// address=[0x47359a0]
__imp__BCryptEncrypt@40;

// address=[0x47359a4]
__imp__BCryptDecrypt@40;

// address=[0x47359a8]
__imp__BCryptExportKey@28;

// address=[0x47359ac]
__imp__BCryptImportKeyPair@28;

// address=[0x47359b0]
__imp__BCryptFinalizeKeyPair@8;

// address=[0x47359b4]
__imp__BCryptDestroyKey@4;

// address=[0x47359b8]
__imp__BCryptDestroyHash@4;

// address=[0x47359bc]
__imp__BCryptDestroySecret@4;

// address=[0x47359c0]
__imp__BCryptCreateHash@28;

// address=[0x47359c4]
__imp__BCryptSecretAgreement@16;

// address=[0x47359c8]
__imp__BCryptGenRandom@16;

// address=[0x47359cc]
__imp__BCryptDeriveKey@28;

// address=[0x47359d0]
__imp__BCryptVerifySignature@28;

// address=[0x47359d4]
bcrypt_NULL_THUNK_DATA;

// address=[0x4735a10]
__imp__BinkDoFrame@4;

// address=[0x4735a14]
__imp__BinkNextFrame@4;

// address=[0x4735a18]
__imp__BinkGetError@0;
...
// address=[0x4735a2c]
__imp__BinkOpenMiles@4;

// address=[0x4735a30]
__imp__BinkSetSoundSystem@8;

// address=[0x4735a34]
__imp__BinkCopyToBuffer@28;

// address=[0x4735a38]
binkw32_NULL_THUNK_DATA;

// address=[0x4735a6c]
__imp__SymGetLineFromAddr@16;

// address=[0x4735a70]
__imp__SymGetModuleBase@8;

// address=[0x4735a74]
__imp__SymGetModuleInfo@12;

// address=[0x4735a78]
__imp__SymFunctionTableAccess@8;

// address=[0x4735a7c]
__imp__SymCleanup@4;

// address=[0x4735a80]
__imp__SymGetOptions@0;

// address=[0x4735a84]
__imp__SymSetOptions@4;

// address=[0x4735a88]
__imp__StackWalk@36;

// address=[0x4735a8c]
__imp__UnDecorateSymbolName@16;

// address=[0x4735a90]
__imp__SymInitialize@12;

// address=[0x4735a94]
__imp__SymGetSymFromAddr@16;

// address=[0x4735a98]
__imp__MiniDumpWriteDump@28;

// address=[0x4735a9c]
dbghelp_NULL_THUNK_DATA;

// address=[0x4735afc]
__imp__RIB_request_interface@16;

// address=[0x4735b88]
__imp__RIB_find_file_provider@12;

// address=[0x4735b90]
mss32_NULL_THUNK_DATA;

// address=[0x4735be0]
__imp__NCryptSignHash@32;

// address=[0x4735be4]
__imp__NCryptFreeObject@4;
...
// address=[0x4735c18]
__imp__PropVariantClear@4;

// address=[0x4735c1c]
__imp__CoUninitialize@0;

// address=[0x4735c20]
__imp__CoInitializeEx@8;

// address=[0x4735c24]
__imp__CoCreateInstance@20;

// address=[0x4735c28]
__imp__StringFromGUID2@12;

// address=[0x4735c2c]
__imp__CoCreateGuid@4;

// address=[0x4735c30]
ole32_NULL_THUNK_DATA;

// address=[0x4735c60]
__imp__UPLAY_GetNextEvent;

// address=[0x4735c64]
__imp__UPLAY_Start;

// address=[0x4735c68]
__imp__UPLAY_PARTY_Init;

// address=[0x4735c6c]
__imp__UPLAY_FRIENDS_ShowInviteFriendsToGameUI;

// address=[0x4735c70]
__imp__UPLAY_FRIENDS_Init;

// address=[0x4735c74]
__imp__UPLAY_USER_GetTicketUtf8;

// address=[0x4735c78]
__imp__UPLAY_USER_IsInOfflineMode;

// address=[0x4735c7c]
__imp__UPLAY_USER_ClearGameSession;

// address=[0x4735c80]
__imp__UPLAY_USER_SetGameSession;

// address=[0x4735c84]
__imp__UPLAY_USER_GetNameUtf8;
...
// address=[0x4735c90]
__imp__UPLAY_HasOverlappedOperationCompleted;

// address=[0x4735c94]
__imp__UPLAY_GetOverlappedOperationResult;

// address=[0x4735c98]
__imp__UPLAY_ACH_ReleaseAchievementList;

// address=[0x4735c9c]
__imp__UPLAY_AVATAR_Release;

// address=[0x4735ca0]
__imp__UPLAY_USER_ReleaseCdKeyList;

// address=[0x4735ca4]
__imp__UPLAY_USER_ReleaseConsumeItemResult;

// address=[0x4735ca8]
__imp__UPLAY_USER_ReleaseProfile;

// address=[0x4735cac]
__imp__UPLAY_SAVE_ReleaseGameList;

// address=[0x4735cb0]
__imp__UPLAY_STORE_ReleaseProductsList;

// address=[0x4735cb4]
__imp__UPLAY_WIN_ReleaseActionList;

// address=[0x4735cb8]
__imp__UPLAY_WIN_ReleaseRewardList;

// address=[0x4735cbc]
__imp__UPLAY_GetLastError;

// address=[0x4735cc0]
__imp__UPLAY_ACH_GetAchievements;

// address=[0x4735cc4]
__imp__UPLAY_ACH_EarnAchievement;

// address=[0x4735cc8]
__imp__UPLAY_AVATAR_Get;

// address=[0x4735ccc]
__imp__UPLAY_USER_GetCdKeys;

// address=[0x4735cd0]
__imp__UPLAY_USER_GetCdKeyUtf8;

// address=[0x4735cd4]
__imp__UPLAY_USER_GetAccountIdUtf8;

// address=[0x4735cd8]
__imp__UPLAY_USER_GetEmailUtf8;

// address=[0x4735cdc]
__imp__UPLAY_USER_IsOwned;

// address=[0x4735ce0]
__imp__UPLAY_USER_GetConsumableItems;

// address=[0x4735ce4]
__imp__UPLAY_USER_ConsumeItem;

// address=[0x4735ce8]
__imp__UPLAY_USER_GetCPUScore;

// address=[0x4735cec]
__imp__UPLAY_USER_GetGPUScore;

// address=[0x4735cf0]
__imp__UPLAY_USER_GetGPUScoreConfidenceLevel;

// address=[0x4735cf4]
__imp__UPLAY_USER_GetProfile;

// address=[0x4735cf8]
__imp__UPLAY_PRESENCE_SetPresence;

// address=[0x4735cfc]
__imp__UPLAY_FRIENDS_GetFriendList;

// address=[0x4735d00]
__imp__UPLAY_FRIENDS_RequestFriendship;

// address=[0x4735d04]
__imp__UPLAY_FRIENDS_IsFriend;

// address=[0x4735d08]
__imp__UPLAY_FRIENDS_AddToBlackList;

// address=[0x4735d0c]
__imp__UPLAY_FRIENDS_RemoveFromBlackList;

// address=[0x4735d10]
__imp__UPLAY_FRIENDS_IsBlackListed;

// address=[0x4735d14]
__imp__UPLAY_FRIENDS_ShowFriendSelectionUI;

// address=[0x4735d18]
__imp__UPLAY_FRIENDS_InviteToGame;

// address=[0x4735d1c]
__imp__UPLAY_FRIENDS_AddPlayedWith;

// address=[0x4735d20]
__imp__UPLAY_FRIENDS_RemoveFriendship;

// address=[0x4735d24]
__imp__UPLAY_METADATA_SetSingleEventTag;

// address=[0x4735d28]
__imp__UPLAY_METADATA_SetContinuousTag;

// address=[0x4735d2c]
__imp__UPLAY_METADATA_ClearContinuousTag;

// address=[0x4735d30]
__imp__UPLAY_OVERLAY_SetShopUrl;

// address=[0x4735d34]
__imp__UPLAY_OVERLAY_ShowBrowserUrl;

// address=[0x4735d38]
__imp__UPLAY_OVERLAY_ShowShopUrl;

// address=[0x4735d3c]
__imp__UPLAY_OVERLAY_ShowNotification;

// address=[0x4735d40]
__imp__UPLAY_PARTY_InviteToParty;

// address=[0x4735d44]
__imp__UPLAY_PARTY_RespondToGameInvite;

// address=[0x4735d48]
__imp__UPLAY_PARTY_ShowGameInviteOverlayUI;

// address=[0x4735d4c]
__imp__UPLAY_PARTY_GetInGameMemberList;

// address=[0x4735d50]
__imp__UPLAY_PARTY_GetFullMemberList;

// address=[0x4735d54]
__imp__UPLAY_PARTY_SetUserData;

// address=[0x4735d58]
__imp__UPLAY_PARTY_IsInParty;

// address=[0x4735d5c]
__imp__UPLAY_PARTY_IsPartyLeader;

// address=[0x4735d60]
__imp__UPLAY_PARTY_GetId;

// address=[0x4735d64]
__imp__UPLAY_PARTY_PromoteToLeader;

// address=[0x4735d68]
__imp__UPLAY_PARTY_InvitePartyToGame;

// address=[0x4735d6c]
__imp__UPLAY_SAVE_GetSavegames;

// address=[0x4735d70]
__imp__UPLAY_SAVE_Open;

// address=[0x4735d74]
__imp__UPLAY_SAVE_Close;

// address=[0x4735d78]
__imp__UPLAY_SAVE_Read;

// address=[0x4735d7c]
__imp__UPLAY_SAVE_Write;

// address=[0x4735d80]
__imp__UPLAY_SAVE_SetName;

// address=[0x4735d84]
__imp__UPLAY_SAVE_Remove;

// address=[0x4735d88]
__imp__UPLAY_STORE_GetProducts;

// address=[0x4735d8c]
__imp__UPLAY_STORE_Checkout;

// address=[0x4735d90]
__imp__UPLAY_STORE_ShowProductDetails;

// address=[0x4735d94]
__imp__UPLAY_WIN_SetActionsCompleted;

// address=[0x4735d98]
__imp__UPLAY_WIN_GetActions;

// address=[0x4735d9c]
__imp__UPLAY_WIN_GetRewards;

// address=[0x4735da0]
__imp__UPLAY_WIN_GetUnitBalance;

// address=[0x4735da4]
__imp__UPLAY_WIN_RefreshActions;

// address=[0x4735da8]
__imp__UPLAY_SetLanguage;

// address=[0x4735dac]
__imp__UPLAY_OVERLAY_Show;
