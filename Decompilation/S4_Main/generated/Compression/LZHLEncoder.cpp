...
void  LZHLEncoder::putMatch(unsigned char const * a2, unsigned int a3, unsigned int a4, unsigned int a5) {
  ...
  if ( a5 >= 0x10000 && BBSupportDbgReport(2, "Source\\compression\\huff.cpp", 268, "disp >= 0 && disp < LZBUFSIZE") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( a4 >= 8 )
  {
    if ( a4 >= 0x26 )
    {
      ...
      LZHLEncoder::_putBits(this, *((_DWORD *)&unk_3E2DBE0 + 3 * (v8 >> 5) + 1) + 4, v8 & 0x1F | (16 * *((unsigned __int16 *)&unk_3E2DBE0 + 6 * (v8 >> 5) + 4)));
    }
    else
    {
      LZHLEncoder::_put(this, *((_WORD *)&unk_3E2DBE0 + 6 * ((a4 - 8) >> 1)), *((_DWORD *)&unk_3E2DBE0 + 3 * ((a4 - 8) >> 1) + 1), ((_BYTE)a4 - 8) & 1 | *((unsigned __int16 *)&unk_3E2DBE0 + 6 * ((a4 - 8) >> 1) + 4));
    }
  }
  else
  {
...
void  LZHLEncoder::_callStat(void) {
  ...
  **((_DWORD **)this + 2) = 2;
  ...
  {
    v4 = v6[i];
    if ( (v4 < v2 || v4 > 8) && BBSupportDbgReport(2, "Source\\compression\\huff.cpp", 251, "nBits >= lastNBits && nBits <= 8") == 1 )
    {
      __debugbreak();
    }
    v1 = v4 - v2;
...
void  LZHLEncoder::_put(unsigned short a2) {
  ...
  if ( a2 >= 0x112u && BBSupportDbgReport(2, "d:\\projects\\tshe\\purplelamp\\s4\\source\\baselib\\source\\compression\\_huff.h", 159, "symbol < NHUFFSYMBOLS") == 1 )
  {
    __debugbreak();
  }
  v2 = **((_DWORD **)this + 2) - 1;
  **((_DWORD **)this + 2) = v2;
  ...
  if ( *v3 < 0 && BBSupportDbgReport(2, "d:\\projects\\tshe\\purplelamp\\s4\\source\\baselib\\source\\compression\\_huff.h", 166, "item->nBits >= 0") == 1 )
  {
    __debugbreak();
  }
...
void  LZHLEncoder::_put(unsigned short a2, int a3, unsigned long a4) {
  ...
  if ( a2 >= 0x112u && BBSupportDbgReport(2, "d:\\projects\\tshe\\purplelamp\\s4\\source\\baselib\\source\\compression\\_huff.h", 173, "symbol < NHUFFSYMBOLS") == 1 )
  {
    __debugbreak();
  }
  if ( a3 > 4 && BBSupportDbgReport(2, "d:\\projects\\tshe\\purplelamp\\s4\\source\\baselib\\source\\compression\\_huff.h", 174, "codeBits <= 4") == 1 )
  {
    __debugbreak();
  }
  v4 = **((_DWORD **)this + 2) - 1;
  **((_DWORD **)this + 2) = v4;
  ...
  if ( *v5 < 0 && BBSupportDbgReport(2, "d:\\projects\\tshe\\purplelamp\\s4\\source\\baselib\\source\\compression\\_huff.h", 181, "item->nBits >= 0") == 1 )
  {
    __debugbreak();
  }
...
void  LZHLEncoder::_putBits(int a2, unsigned long a3) {
  ...
  if ( a2 > 16 && BBSupportDbgReport(2, "d:\\projects\\tshe\\purplelamp\\s4\\source\\baselib\\source\\compression\\_huff.h", 145, "codeBits <= 16") == 1 )
  {
    __debugbreak();
  }
