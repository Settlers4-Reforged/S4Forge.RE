...
int CDecoObjMgr::AddLoadedDecoObj(int _iX, int _iY, int _iDecoType, int _iAmount, int _iSlot, bool a7, std::istream *_pInStream) {
  if((_iDecoType <= OBJECT_NO_OBJECT || _iDecoType >= OBJECT_MAX)
  ...
  if(a7)
    return CDecoObjMgr::Create(this, _iX, _iY, _iDecoType, _iAmount, 1, _iSlot, _pInStream);
  else
    return CDecoObjMgr::Create(this, _iX, _iY, _iDecoType, _iAmount, 0, _iSlot, _pInStream);
}
...
void CDecoObjMgr::Store(class S4::CMapFile &a2) {
  ...
  v23 = -1;
  std::ostrstream::` vbase destructor
  '((std::ostrstream *)
  v4
  )
  ;
...
void CDecoObjMgr::Load(class S4::CMapFile &a2) {
  ...
  if(pData) {
    ...
    LOBYTE(v31) = 0;
    std::istringstream::` vbase destructor
    '(stream
    )
    ;
    v31 = -1;
