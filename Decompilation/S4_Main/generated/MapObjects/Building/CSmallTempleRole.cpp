...
int  CSmallTempleRole::GetBuildingNeed(int a2)const {
...
int  CSmallTempleRole::GetPileIdWithGood(int a2)const {
...
void  CSmallTempleRole::GoodArrive(int a2) {
...
void  CSmallTempleRole::LogicUpdate(class CBuilding * a2) {
  ...
  if ( v8 != 3 )
    return result;
  if ( !*((_BYTE *)v9 + 29) || !IEntity::FlagBits(a2, EntityFlag_NotStriking) || !CSmallTempleRole::HaveMaterial(v9, a2) )
    return IAnimatedEntity::RegisterForLogicUpdate(31);
...
void  CSmallTempleRole::Init(class CBuilding * a2) {
...
void  CSmallTempleRole::PostLoadInit(class CBuilding * a2) {
...
bool  CSmallTempleRole::SettlerEnter(class CBuilding * a2, int a3) {
...
void  CSmallTempleRole::FillDialog(class CBuilding * a2, bool a3) {
  ...
  byte_3F1E5D3 = 1;
  byte_3F1E5D4 = IEntity::FlagBits(a2, EntityFlag_NotStriking) != 0;
...
void  CSmallTempleRole::LockPiles(class CBuilding * a2, bool a3) {
...
void  CSmallTempleRole::Store(std::ostream & a2) {
