...
void  CMineRole::LogicUpdate(class CBuilding * a2) {
  ...
  if ( !*((_BYTE *)this + 29) || !IEntity::FlagBits(a2, (EntityFlag)0x1000u) || (v6 = CPileMgr::operator[](*((unsigned __int16 *)this + 191)), (*(int (__thiscall **)(unsigned __int8 *))(*(_DWORD *)v6 + 40))(v6) >= 8) )
  {
LABEL_27:
...
void  CMineRole::Init(class CBuilding * a2) {
  ...
  *((_WORD *)this + 191) = 0;
        ...
        ++i )
  {
    ...
    {
      if ( *((_WORD *)this + 191) && BBSupportDbgReport(2, "MapObjects\\Building\\MineRole.cpp", 227, "m_uProdPileId == 0") == 1 )
      {
        __debugbreak();
      }
      *((_WORD *)this + 191) = v11;
  ...
  if ( !*((_WORD *)this + 191) && BBSupportDbgReport(2, "MapObjects\\Building\\MineRole.cpp", 243, "m_uProdPileId != 0") == 1 )
  {
    __debugbreak();
  }
  if ( !std::vector<unsigned short>::size((char *)this + 392) && BBSupportDbgReport(2, "MapObjects\\Building\\MineRole.cpp", 244, "m_vDeliverPileId.size()>0") == 1 )
  {
    __debugbreak();
  }
  *((_BYTE *)this + 381) = 10;
...
bool  CMineRole::SettlerEnter(class CBuilding * a2, int a3) {
  ...
  if ( *((_BYTE *)v25 + 29) )
  {
    if ( *((unsigned __int16 *)v25 + 4) != a3 && BBSupportDbgReport(2, "MapObjects\\Building\\MineRole.cpp", 307, "m_uSettlerId == _iSettlerId") == 1 )
    {
      __debugbreak();
    }
  }
...
void  CMineRole::GoodArrive(int a2) {
  ...
  result = IEntity::FlagBits(v2, ENTITY_FLAG_Registered);
  if ( result )
  {
    return result;
  }
...
void  CMineRole::FillDialog(class CBuilding * a2, bool a3) {
  ...
  for ( i = 0;
        i < std::vector<unsigned short>::size((char *)this + 392);
        ++i )
  {
...
int  CMineRole::GetProductivity(class CBuilding * a2) {
  ...
  for ( i = 0;
        ...
        ++i )
  {
    if ( *((_BYTE *)this + i + 424) != 100 && *((_BYTE *)this + i + 424) && BBSupportDbgReport(2, "MapObjects\\Building\\MineRole.cpp", 956, "m_caProductionHistory[i] == 100 || m_caProductionHistory[i] == 0") == 1 )
    {
      __debugbreak();
    }
    v4 += *((char *)this + i + 424);
...
void  CMineRole::Work(class CBuilding * a2) {
  ...
  {
    if ( !*(_BYTE *)std::vector<unsigned char>::operator[](0) && BBSupportDbgReport(2, "MapObjects\\Building\\MineRole.cpp", 686, "m_pBuildingInfo->vAnimListId[0] != 0") == 1 )
    {
      __debugbreak();
    }
...
void  CMineRole::TakeNextFood(class CBuilding * a2) {
  ...
  v14 = 0;
  for ( i = 0;
        i < std::vector<unsigned short>::size((char *)this + 408);
        ++i )
  {
