...
class CVehicle * __cdecl CVehicleMgr::GetVehiclePtr(int a1) {
  ...
  if ( !j____RTDynamicCast((void **)v3, 0, &IEntity__RTTI_Type_Descriptor_, &CVehicle__RTTI_Type_Descriptor_, 0) && BBSupportDbgReport(2, "D:\\Projects\\TSHE\\PurpleLamp\\S4\\source\\S4_Main\\MapObjects\\VehicleMgr.h", 248, "dynamic_cast< CVehicle* >( pEntity ) != 0") == 1 )
  {
    __debugbreak();
  }
  return v3;
...
int  CVehicleMgr::AddVehicle(int a2, int a3, int a4, int a5, int a6, bool a7) {
  ...
  if ( (a2 != -1 || a3) && !(unsigned __int8)CWorldManager::InWorld(a2, a3) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 555, "(_iX == -1 && _iY == 0) || g_cWorld.InWorld( _iX, _iY )") == 1 )
  {
    __debugbreak();
  }
  if ( (a4 <= 0 || a4 >= 9) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 556, "_iOwnerId>0 && _iOwnerId<PLAYER_MAX") == 1 )
  {
    __debugbreak();
  }
  if ( a5 == 1030 )
  ...
  if ( (v9 <= 0 || v9 >= 6) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 560, "iVehicleType>0 && iVehicleType<VEHICLE_MAX") == 1 )
  {
    __debugbreak();
  }
...
void  CVehicleMgr::DeleteVehicle(int a2) {
  ...
  if ( (a2 <= 0 || a2 >= 0xFFFF) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 856, "_iVehicleId>0 && _iVehicleId<CMapObjectMgr::MAX_ENTRIES") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( IEntity::ObjType(v2) != 2 )
  {
    ...
    if ( IEntity::ObjType(v3) != 4 && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 859, "g_pMapObjectMgr->Entity( _iVehicleId ).ObjType() == SHIP_OBJ || g_pMapObjectMgr->Entity( _iVehicleId ).ObjType() == CATAPULT_OBJ") == 1 )
    {
      __debugbreak();
    }
  }
...
int  CVehicleMgr::GetNearestVehicle(int a2, int a3, int a4, int a5) {
  ...
  if ( (a2 <= 0 || a2 > CPlayerManager::LastPlayerId()) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 822, "_iOwnerId>0 && _iOwnerId <= g_cPlayerMgr.LastPlayerId()") == 1 )
  {
    __debugbreak();
  }
  if ( (a3 <= 0 || a3 >= 6) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 823, "_iVehicleType>0 && _iVehicleType<VEHICLE_MAX") == 1 )
  {
    __debugbreak();
  }
  if ( !(unsigned __int8)CWorldManager::InWorld(a4, a5) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 824, "g_cWorld.InWorld( _iX, _iY)") == 1 )
  {
    __debugbreak();
  }
  v10 = -1;
  v9 = 0;
  for ( i = CVehicleMgr::GetFirstVehicleId(this, a2, a3);
        i;
...
class CFerryShip * __cdecl CVehicleMgr::GetFerryShipAt(int a1, int a2) {
  ...
  if ( !(unsigned __int8)CWorldManager::InWorld(a1, a2) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 1093, "g_cWorld.InWorld(_iX, _iY)") == 1 )
  {
    __debugbreak();
  }
...
void  CVehicleMgr::Load(class S4::CMapFile & a2) {
  ...
  if ( Str )
  {
          ...
          ++i )
    {
      ...
      IEntity::ClearFlagBits(v29, ENTITY_FLAG_Selected);
      ...
      if ( v7 == SHIP_OBJ )
      {
        ...
        {
          IEntity::ClearFlagBits(v29, ENTITY_FLAG_Visible);
...
int __cdecl CVehicleMgr::Create(int a1, int a2, int a3, int a4, int a5, bool a6) {
  ...
  if ( (a1 != -1 || a2) && !(unsigned __int8)CWorldManager::InWorld(a1, a2) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 611, "( _iX == -1 && _iY == 0) || g_cWorld.InWorld( _iX, _iY )") == 1 )
  {
    __debugbreak();
  }
  if ( !CPlayerManager::ValidUsedPlayerId(a3) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 612, "g_cPlayerMgr.ValidUsedPlayerId( _iOwnerId )") == 1 )
  {
    __debugbreak();
  }
  if ( (v20 <= 0 || v20 >= 6) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 613, "iVehicleType > 0 && iVehicleType < VEHICLE_MAX") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( v22 && BBSupportDbgReport(1, "MapObjects\\VehicleMgr.cpp", 723, "The program can't use this vehicle at the moment!") == 1 )
  {
    __debugbreak();
  }
  return FreeSlot;
...
void  CVehicleMgr::AttachVehicle(int a2, int a3, int a4) {
  ...
  if ( (a2 <= 0 || a2 >= 9) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 945, "_iOwnerId>0 && _iOwnerId<PLAYER_MAX") == 1 )
  {
    __debugbreak();
  }
  if ( (a3 <= 0 || a3 >= 6) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 946, "_iVehicleType>0 && _iVehicleType<VEHICLE_MAX") == 1 )
  {
    __debugbreak();
  }
...
void  CVehicleMgr::DetachVehicle(int a2, int a3, int a4) {
  ...
  if ( (a2 <= 0 || a2 >= 9) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 974, "_iOwnerId>0 && _iOwnerId<PLAYER_MAX") == 1 )
  {
    __debugbreak();
  }
  if ( (a3 <= 0 || a3 >= 6) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 975, "_iVehicleType>0 && _iVehicleType<VEHICLE_MAX") == 1 )
  {
    __debugbreak();
  }
  ...
  {
    if ( *((unsigned __int16 *)this + 6 * a2 + a3 + 176) != a4 && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 988, "m_iVehicleFirstIds[_iOwnerId][_iVehicleType] == _iVehicleId") == 1 )
    {
      __debugbreak();
    }
...
void  CVehicleMgr::CheckOutVehicle(int a2) {
  ...
  if ( (a2 <= 0 || a2 >= 0xFFFF) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 885, "_iVehicleId>0 && _iVehicleId<CMapObjectMgr::MAX_ENTRIES") == 1 )
  {
    __debugbreak();
  }
  ...
  v2 = 2;
  if ( IEntity::FlagBits(v6, (EntityFlag)&dword_F29144[220079]) || !IEntity::FlagBits(v6, (EntityFlag)&loc_3000000) && IEntity::FlagBits(v6, (EntityFlag)0x100000u) )
  {
    v2 = 1;
  }
