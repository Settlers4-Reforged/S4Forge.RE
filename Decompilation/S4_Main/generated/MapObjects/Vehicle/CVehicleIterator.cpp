...
class CVehicle *  CVehicleIterator::FirstVehicle(void) {
  ...
  if ( (*(int *)this <= 0 || *(int *)this >= 9) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 1122, "(m_iPlayerId > 0) && (m_iPlayerId < PLAYER_MAX)") == 1 )
  {
    __debugbreak();
  }
  if ( (*((int *)this + 1) <= 0 || *((int *)this + 1) >= 6) && BBSupportDbgReport(2, "MapObjects\\VehicleMgr.cpp", 1123, "(m_iVehicleType > 0) && (m_iVehicleType < VEHICLE_MAX)") == 1 )
  {
    __debugbreak();
  }
