...
int  CGroupMgr::GetGroupSize(int playerId, int groupId)const {
  ...
  if ( (playerId < 1 || playerId > 8) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 220, "(_iPlayerId >= PLAYER_FIRST) && (_iPlayerId <= PLAYER_LAST)") == 1 )
  {
    __debugbreak();
  }
  if ( (groupId < 1 || groupId > 10) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 221, "(_iGroupId >= GROUP_FIRST) && (_iGroupId <= GROUP_LAST)") == 1 )
  {
    __debugbreak();
  }
...
unsigned short const *  CGroupMgr::GetGroupEntityIds(int playerId, int groupId)const {
  ...
  if ( (playerId < 1 || playerId > 8) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 233, "(_iPlayerId >= PLAYER_FIRST) && (_iPlayerId <= PLAYER_LAST)") == 1 )
  {
    __debugbreak();
  }
  if ( (groupId < 1 || groupId > 10) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 234, "(_iGroupId >= GROUP_FIRST) && (_iGroupId <= GROUP_LAST)") == 1 )
  {
    __debugbreak();
  }
...
bool  CGroupMgr::AttachEntity(int playerId, int groupId, int entityIdToAttach) {
  ...
  if ( (playerId < 1 || playerId > 8) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 246, "(_iPlayerId >= PLAYER_FIRST) && (_iPlayerId <= PLAYER_LAST)") == 1 )
  {
    __debugbreak();
  }
  if ( (groupId < 1 || groupId > 10) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 247, "(_iGroupId >= GROUP_FIRST) && (_iGroupId <= GROUP_LAST)") == 1 )
  {
    __debugbreak();
  }
  ...
  a1 = entityIdToAttach;
  if ( TStaticArray<unsigned short,100>::FindEntry(groupList, &a1) >= 0 && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 267, "rGroupArray.FindEntry(_iEntityId) < 0") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( entityToAttach->SetGroupFlags(entityToAttach, groupFlagBits | (groupId << 12)) != (void *)(groupFlagBits | (groupId << 12)) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 300, "iGroupFlags == iNewGroupFlags") == 1 )
  {
    __debugbreak();
  }
...
bool  CGroupMgr::DetachEntity(int playerId, int groupId, int entityId) {
  ...
  if ( (playerId < 1 || playerId > 8) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 339, "(_iPlayerId >= PLAYER_FIRST) && (_iPlayerId <= PLAYER_LAST)") == 1 )
  {
    __debugbreak();
  }
  if ( (groupId < 1 || groupId > 10) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 340, "(_iGroupId >= GROUP_FIRST) && (_iGroupId <= GROUP_LAST)") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( IEntity::CheckType(entity, 1, 44) )
  {
    ...
    if ( (this->m_bGroupFlags[11 * playerId + groupId] & 1) == 0 && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 376, "(m_uPlayersGroupsFlags[_iPlayerId][_iGroupId] & PLAYER_GROUP_FLAG_HAS_SQUAD_LEADER) != 0") == 1 )
    {
      __debugbreak();
    }
    this->m_bGroupFlags[11 * playerId + groupId] &= ~1u;
...
void  CGroupMgr::DetachAllEntitiesFromGroup(int playerId, int groupId) {
  ...
  if ( (playerId < 1 || playerId > 8) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 449, "(_iPlayerId >= PLAYER_FIRST) && (_iPlayerId <= PLAYER_LAST)") == 1 )
  {
    __debugbreak();
  }
  if ( (groupId < 1 || groupId > 10) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 450, "(_iGroupId >= GROUP_FIRST) && (_iGroupId <= GROUP_LAST)") == 1 )
  {
    __debugbreak();
  }
  ...
  while ( 1 )
  {
    ...
    if ( TStaticArray<unsigned short,100>::Size(v7) != v6 - 1 && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 461, "rGroupArray.Size() == (iOldSize - 1)") == 1 )
    {
      __debugbreak();
    }
    if ( TStaticArray<unsigned short,100>::Size(v7) >= v6 )
    {
      if ( *TStaticArray<unsigned short,100>::operator[](v7, v6 - 1) != v4 && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 465, "rGroupArray[iOldSize - 1] == iEntityId") == 1 )
      {
        __debugbreak();
      }
      TStaticArray<unsigned short,100>::PopBack(v7);
    }
    if ( TStaticArray<unsigned short,100>::Size(v7) != v6 - 1 && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 470, "rGroupArray.Size() == (iOldSize - 1)") == 1 )
    {
      __debugbreak();
    }
  }
...
bool  CGroupMgr::HasSquadLeader(int a2, int a3) {
  ...
  if ( (a2 < 1 || a2 > 8) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 481, "(_iPlayerId >= PLAYER_FIRST) && (_iPlayerId <= PLAYER_LAST)") == 1 )
  {
    __debugbreak();
  }
  if ( (a3 < 1 || a3 > 10) && BBSupportDbgReport(2, "MapObjects\\GroupMgr.cpp", 482, "(_iGroupId >= GROUP_FIRST) && (_iGroupId <= GROUP_LAST)") == 1 )
  {
    __debugbreak();
  }
  ...
  if ( groupSize > 0 && group )
  {
    ...
    if ( i >= 0 )
    {
      ...
      else
      {
        ...
        CGroupDestinations::CGroupDestinations((CGroupDestinations *)v30, x, y, groupSize, v23, firstGroupMemberPackedXY);
        while ( i < groupSize )
        {
...
// Decompiled from CGroupMgr *__thiscall CGroupMgr::CGroupMgr(CGroupMgr *this)
 CGroupMgr::CGroupMgr(void) {
  ...
  _vec_ctor_no(this->m_vEntries, 204u, 99u, (void *(__thiscall *)(void *))TStaticArray<unsigned short,100>::TStaticArray<unsigned short,100>);
  return this;
}
