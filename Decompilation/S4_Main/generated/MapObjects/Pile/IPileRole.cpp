...
void  IPileRole::NotifyChangeEcoSector(class CPile * a2, int a3, int a4) {
...
void  IPileRole::Store(std::ostream & a2) {
...
bool  IPileRole::ExecuteChangeGoodTypeUnforseen(class CPile * a2, int a3) {
