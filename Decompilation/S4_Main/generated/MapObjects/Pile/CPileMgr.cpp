...
class CPile &CPileMgr::operator[](int _iPileId) {
    ...
    if(IEntity::ObjType(pEntity) != PILE_OBJ && BBSupportDbgReport(
                                                    2,
                                                    "D:\\Projects\\TSHE\\PurpleLamp\\S4\\source\\S4_Main\\MapObjects\\Pile\\PileMgr.h",
                                                    175,
...
int CPileMgr::GetNearestPile(int _iPileId, int a3, int a4) {
    ...
    v8 = 0;
    v9 = -1;
    pPile = (CPile *)CPileMgr::GetPilePtr(_iPileId);
...
void CPileMgr::Load(class S4::CMapFile &_rMapFile) {
    ...
    if(Str) {
        ...
        LOBYTE(v13) = 0;
        std::istringstream::` vbase destructor'(v2); v13 = -1; std::string::~string(&v12);
    }
}
