...
int __cdecl COwnerMap::OwnerBits1VW(int a1, int a2) {
...
int __cdecl COwnerMap::OwnerBits9VW(int a1, int a2) {
...
int __cdecl COwnerMap::OwnerBit(int a1) {
...
// address=[0x15afa20]
// Decompiled from int __cdecl COwnerMap::OwnerBits9XY(int a1, int a2)
int __cdecl COwnerMap::OwnerBits9XY(int a1, int a2) {
...
void __cdecl COwnerMap::ClearOwnerBits(void) {
...
unsigned char & __cdecl COwnerMap::OwnerBits1VWRef(int a1, int a2) {
...
unsigned char & __cdecl COwnerMap::OwnerBits9VWRef(int a1, int a2) {
