...
// Decompiled from CClient *__thiscall CClient::CClient(CClient *this)
 CClient::CClient(void) {
  ...
  this->vftable = (CClient_vtbl *)&CClient::_vftable_;
  this->m_bReady = 0;
  this->m_uPeerId = -1;
...
bool  CClient::operator==(unsigned int a2) {
  ...
  return this->m_uPeerId == a2;
}


// address=[0x15b3530]
// Decompiled from CClient *__thiscall CClient::operator=(CClient *this, CClient *a2)
