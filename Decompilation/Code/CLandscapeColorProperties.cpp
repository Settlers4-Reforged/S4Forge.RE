...
// address=[0x2f8dcb0]
// Decompiled from CLandscapeColorProperties *__thiscall CLandscapeColorProperties::CLandscapeColorProperties(
        CLandscapeColorProperties *this)
  ...
  *((_BYTE *)this + 583) = 40;
  *((_WORD *)this + 23) = 0;
  qmemcpy((char *)this + 800, "2Fd2Pd<Fd22d", 12);
  *((_WORD *)this + 96) = 0;
  *((_WORD *)this + 97) = 0;
  *((_WORD *)this + 98) = 0;
  *((_WORD *)this + 99) = 0;
  ...
  *((_WORD *)this + 29) = 0;
  for ( i = 0; i < 256; ++i )
    *((_WORD *)this + i) = (unsigned __int8)(int)(float)((float)*((unsigned __int8 *)this + 3 * i + 514) * 0.12156863)
                         + 32
                         * (unsigned __int8)(int)(float)((float)*((unsigned __int8 *)this + 3 * i + 513) * 0.12156863)
                         + ((unsigned __int8)(int)(float)((float)*((unsigned __int8 *)this + 3 * i + 512) * 0.12156863) << 10);
  return this;
}
