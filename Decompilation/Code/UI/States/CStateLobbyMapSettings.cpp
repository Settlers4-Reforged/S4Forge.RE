...
// address=[0x14bd770]
// Decompiled from CStateLobbyMapSettings *__thiscall CStateLobbyMapSettings::CStateLobbyMapSettings(
        CStateLobbyMapSettings *this,
        void *a2)
...
// address=[0x14be980]
// Decompiled from void __thiscall CStateLobbyMapSettings::AddMapList(
        _BYTE *this,
        int a2,
        int a3,
        int a4,
