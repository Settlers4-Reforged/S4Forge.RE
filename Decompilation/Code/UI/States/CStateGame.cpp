...
int __thiscall CStateGame::GetTickCounter(CStateGame *this)
...
int __thiscall CStateGame::EndGame(CStateGame *this)
...
// address=[0x14a69e0]
// Decompiled from void __thiscall CStateGame::SendLogicMessage(
        CStateGame *this,
        unsigned int a2,
        unsigned int a3,
        unsigned int a4,
