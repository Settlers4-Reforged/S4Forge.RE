...
public:
    ...
    // address=[0x1616210]
    void  CreateSession(class CGameType *);

    // address=[0x1616430]
    void  QuickMatch(class CGameType *);
    ...
    // address=[0x1616660]
    void  UpdateDiscoveredSessions(class std::list<struct SGameInfo,class std::allocator<struct SGameInfo> > &);
    ...
    // address=[0x1616dd0]
    void  GetPlayerData(int,bool &,int &,int &,int &,int &,int &,int &,class String &);

    // address=[0x1616ec0]
    void  SendUnicastGameSetup(int,void *,unsigned long);

    // address=[0x1617140]
    void  SendUnicastPlayerMessage(int,char const *,int);

    // address=[0x16171e0]
    void  GetMessageCount(unsigned long &);

    // address=[0x1617200]
    bool  Receive(void *,int &,unsigned int &);

    // address=[0x16172f0]
    void  Send(unsigned long,void *,unsigned long);
...
private:
    // address=[0x16176d0]
    void  UpdatePlayerData(int,bool,int,int,int,int,int,char const *,char const *);
