...
// address=[0x12fc830]
// Decompiled from CStaticConfigVarInt *__thiscall CStaticConfigVarInt::CStaticConfigVarInt(
        CStaticConfigVarInt *this,
        const char *a2,
        const char *a3,
        int a4)
...
// MFC 3.1-14.0 32bit
int __thiscall CStaticConfigVarInt::operator int(_DWORD *this)
...
// Decompiled from // Microsoft VisualC 14/net runtime
// MFC 3.1-14.0 32bit
int __thiscall CStaticConfigVarInt::GetIntValue(CStaticConfigVarInt *this)
...
CStaticConfigVarInt *__thiscall CStaticConfigVarInt::SetValue(CStaticConfigVarInt *this, int a2)
