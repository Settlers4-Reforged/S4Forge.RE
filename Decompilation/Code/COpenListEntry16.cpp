...
bool  COpenListEntry16::operator<(class COpenListEntry16 const &)const {
...
// MFC 3.1-14.0 32bit
int __thiscall COpenListEntry16::Index(COpenListEntry16 *this)
...
void  COpenListEntry16::Set(int,int,int) {
