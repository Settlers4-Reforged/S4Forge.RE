...
// address=[0x132ba20]
// Decompiled from int __thiscall CAITaskForcePriestsViking::ChooseMilitarySpell(
        CAITaskForcePriestsViking *this,
...
// address=[0x132bb20]
// Decompiled from int __thiscall CAITaskForcePriestsViking::ChooseMilitarySpellDestination(
        CAITaskForcePriestsViking *this,
        int a2,
        int a3,
        int a4,
