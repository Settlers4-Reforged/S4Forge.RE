...
public:
    ...
    // address=[0x14fdab0]
    static class CManakopterHallRole * __cdecl Load(std::istream &);

    // address=[0x150c8f0]
     CManakopterHallRole(std::istream &);
    ...
    // address=[0x150d570]
    void  TeleportGoods(int,int);

    // address=[0x150d640]
    bool  TryMakingManakopter(class CBuilding *);

    // address=[0x150d6f0]
    bool  CheatIfRequired(class CBuilding *);
