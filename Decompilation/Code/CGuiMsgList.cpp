...
// address=[0x13b8400]
// Decompiled from // public: bool __thiscall CGuiMsgList::SetListindex(int)
char __thiscall CGuiMsgList::SetListindex(_DWORD *this, int a2)
...
// MFC 3.1-14.0 32bit
void __thiscall CGuiMsgList::~CGuiMsgList(CGuiMsgList *this)
