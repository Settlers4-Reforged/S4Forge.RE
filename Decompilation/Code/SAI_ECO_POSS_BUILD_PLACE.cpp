...
// address=[0x1345770]
// Decompiled from SAI_ECO_POSS_BUILD_PLACE *__thiscall SAI_ECO_POSS_BUILD_PLACE::SAI_ECO_POSS_BUILD_PLACE(
        SAI_ECO_POSS_BUILD_PLACE *this,
        const struct SAI_ECO_POSS_BUILD_PLACE *a2)
