...
// address=[0x150d170]
// Decompiled from int __thiscall CManakopterHallRole::FillGfxInfo(
        CManakopterHallRole *this,
        struct CBuilding *a2,
...
// address=[0x150dd60]
// Decompiled from void __thiscall CManakopterHallRole::ConvertEventIntoGoal(
        CManakopterHallRole *this,
        struct CBuilding *a2,
