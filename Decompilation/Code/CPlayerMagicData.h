...
public:
    ...
    // address=[0x1470db0]
    int  SpellCategoryCost(int)const;

    // address=[0x1470de0]
    int  SpellCategoryCounter(int)const;
...
protected:
    ...
    // address=[0x1470b90]
    int  MaxSpellCastNumber(int)const;

    // address=[0x1470c90]
    void  SetManaAmount(int);

    // address=[0x1470cd0]
    void  SetManaAmountChangedFlag(void);

    // address=[0x1470cf0]
    void  SetMaxSpellCastNumber(int,int);

    // address=[0x1470d10]
    void  SetSpellCategoryCost(int,int);

    // address=[0x1470d40]
    void  SetSpellCategoryCounter(int,int);

    // address=[0x1470d80]
    void  SetTotalAmountOfCollectedMana(int);

    // address=[0x14731d0]
    void  Clear(void);

    // address=[0x1474cd0]
    void  SetMaxNumberOfBigTemples(int);
